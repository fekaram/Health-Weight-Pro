...
Refeição:`});function Fe(e){return Pe[e]??Pe.en}var Ie=[`breakfast`,`lunch`,`dinner`],O=[`morningSnack`,`afternoonSnack`,`preWorkout`,`postWorkout`,`supper`],Le=[...Ie,...O];function Re(e={}){let t=O.filter(t=>e.mealSlots?.[t]);return[...Ie,...t]}function k(e){return Le.includes(e)?`mealSlot.${e}`:`meal.${e}`}var ze=/^HWP_FOOD\s*$/i,Be=/^([a-zA-Z]+)\s*=\s*(.*)$/,Ve=[...Le,`snack`,`meal`];function He(e){let t=String(e??``).split(/\r?\n/),n=t.findIndex(e=>ze.test(e.trim()));if(n===-1)return{valid:!1};let r={},i=[t[n]];for(let e=n+1;e<t.length;e+=1){let n=t[e],a=n.trim();if(!a){if(Object.keys(r).length>0)break;continue}let o=a.match(Be);if(!o)break;r[o[1].trim().toLowerCase()]=o[2].trim(),i.push(n)}let a=String(r.name??``).trim(),o=Ue(r.slot),s=A(r.calories),c=A(r.protein),l=A(r.carbs??r.carbohydrates),u=A(r.fat),d=A(r.fiber)??0;return!a||s===null||c===null||l===null||u===null?{valid:!1}:{valid:!0,data:{mealType:o,name:a,calories:s,protein:c,carbs:l,fat:u,fiber:d},raw:i.join(`
`)}}function Ue(e){let t=String(e??``).trim().toLowerCase();return Ve.find(e=>e.toLowerCase()===t)??`meal`}function A(e){if(e==null||e===``)return null;let t=Number(e);return Number.isFinite(t)&&t>=0?t:null}function We({root:e,viewModel:t}){let n=t.getState();e.innerHTML=`
    <main class="app-shell">
      <aside class="app-shell__sidebar" aria-label="${n.i18n.t(`aria.primaryNavigation`)}">
        ${qe(n)}
        ${Je(n.routes,n.currentRoute)}
      </aside>
      <section class="app-shell__workspace">
        <header class="app-shell__topbar">
          ${qe(n)}
          <nav class="app-shell__mobile-nav" aria-label="${n.i18n.t(`aria.mobileNavigation`)}">
            ${Ye(n.routes,n.currentRoute)}
          </nav>
        </header>
        <section class="app-shell__content" aria-live="polite">
          ${Qe(n.currentRoute,n.currentModuleState)}
        </section>
      </section>
      <div class="app-shell__fab-region">
        ${it(n.fab,n.routes,n.i18n)}
      </div>
    </main>
  `,pt(e.querySelector(`.app-shell__fab-region`),n.i18n),n.currentRoute.afterRender?.(e.querySelector(`.app-shell__content`),n.currentModuleState),e.addEventListener(`click`,async n=>{let r=n.target.closest(`[data-route]`);if(r){n.preventDefault(),r.classList.contains(`app-shell__brand`)&&(await t.handleAction(`developer`,`tapLogo`,{}),t.modules.developer?.getState().justEnabled&&S({icon:`🛠`,title:t.getI18nContext().t(`developer.enabledTitle`),message:t.getI18nContext().t(`developer.enabledMessage`)})),t.navigate(r.dataset.route);return}if(n.target.closest(`[data-copy-prompt]`)){n.preventDefault(),await tt(t.getI18nContext());return}if(n.target.closest(`[data-export-logs]`)){n.preventDefault(),await nt(t);return}let i=n.target.closest(`button[data-action], [role="button"][data-action]`);if(!i||i.type===`submit`)return;n.preventDefault();let a=$e(i,t),o=i.dataset.action;if(await t.handleAction(a,o,{...i.dataset}),a===`meal-journal`&&o===`importHwpFood`){await rt({root:e,viewModel:t,importButton:i});return}if(a===`favorites`&&o===`startFromImportedMeal`){t.navigate(`/favorites`),j({root:e,state:t.getState(),route:t.getState().currentRoute});return}a===`favorites`&&o===`register`&&S({icon:`⭐`,title:t.getI18nContext().t(`toast.favoriteRegistered.title`),message:t.getI18nContext().t(`toast.favoriteRegistered.message`)}),a===`meal-plans`&&o===`register`&&S({icon:`🍽`,title:t.getI18nContext().t(`toast.mealPlanRegistered.title`),message:t.getI18nContext().t(`toast.mealPlanRegistered.message`)}),j({root:e,state:t.getState(),route:t.getState().currentRoute})}),e.addEventListener(`submit`,async n=>{let r=n.target.closest(`form[data-action]`);r&&(n.preventDefault(),await t.handleAction($e(r,t),r.dataset.action,et(r)),j({root:e,state:t.getState(),route:t.getState().currentRoute}))}),e.addEventListener(`keydown`,e=>{if(e.key!==`Enter`&&e.key!==` `)return;let t=e.target.closest(`[role="button"][tabindex]`);t&&(e.preventDefault(),t.click())}),document.addEventListener(`keydown`,async n=>{n.key===`Escape`&&await Ke({root:e,viewModel:t})}),t.onRouteChange(n=>{j({root:e,state:t.getState(),route:n})})}var Ge=Object.freeze({favorites:`closeDialog`,"food-library":`closeDialog`,"meal-plans":`closeDialog`});async function Ke({root:e,viewModel:t}){let n=t.getState();if(n.fab?.isOpen){await t.handleAction(`fab`,`close`,{}),j({root:e,state:t.getState(),route:t.getState().currentRoute});return}let r=n.currentRoute.moduleKey,i=n.currentModuleState??{};if(r===`settings`&&i.developer?.confirmingAction){await t.handleAction(`developer`,`cancelConfirm`,{}),j({root:e,state:t.getState(),route:t.getState().currentRoute});return}i.activeDialog&&Ge[r]&&(await t.handleAction(r,Ge[r],{}),j({root:e,state:t.getState(),route:t.getState().currentRoute}))}function qe(e){return`
  ...
  `}function Je(e,t){let n=e.filter(e=>!e.hidden);return[...new Set(n.map(e=>e.section))].map(e=>`
        <div class="app-shell__nav-group">
          <p class="app-shell__nav-heading">${e}</p>
          <nav class="app-shell__links" aria-label="${e}">
            ${n.filter(t=>t.section===e).map(e=>Xe(e,t)).join(``)}
          </nav>
        </div>
      `).join(``)}function Ye(e,t){return e.filter(e=>!e.hidden).map(e=>Xe(e,t)).join(``)}function Xe(e,t){let n=e.path===t.path;return`
    <a
      ...
      ${n?`aria-current="page"`:``}
    >
      <span class="app-shell__link-mark" aria-hidden="true">${Ze(e.id)}</span>
      <span>${e.label}</span>
    </a>
  `}function Ze(e){let t={dashboard:`<path d="M3 13h8V3H3v10Z"></path><path d="M13 21h8V11h-8v10Z"></path><path d="M13 3v6h8V3h-8Z"></path><path d="M3 21h8v-6H3v6Z"></path>`,"meal-journal":`<path d="M4 3v7a4 4 0 0 0 4 4v7"></path><path d="M8 3v18"></path><path d="M12 3v7a4 4 0 0 1-4 4"></path><path d="M17 3v18"></path><path d="M17 3c2.5 2 3.5 4.5 3 8h-3"></path>`,"weight-tracking":`<path d="M12 3v3"></path><path d="M6 7h12l3 12H3L6 7Z"></path><path d="m9 12 3 3 3-3"></path>`,"body-measurements":`<path d="M4 7h16"></path><path d="M4 17h16"></path><path d="M6 7v10"></path><path d="M10 7v5"></path><path d="M14 7v10"></path><path d="M18 7v5"></path>`,medication:`<path d="m18 2 4 4"></path><path d="m17 7 3-3"></path><path d="M19 9 8 20l-4-4L15 5l4 4Z"></path><path d="m9 7 8 8"></path><path d="m4 20-2 2"></path>`,settings:`<path d="M12 15.5A3.5 3.5 0 1 0 12 8a3.5 3.5 0 0 0 0 7.5Z"></path><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.9 1.7 1.7 0 0 0-1.6-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.3-1.9l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.9.3H9a1.7 1.7 0 0 0 1-1.6V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.9v.1a1.7 1.7 0 0 0 1.6 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1Z"></path>`,"backup-restore":`<path d="M4 7c0-2 3.6-4 8-4s8 2 8 4-3.6 4-8 4-8-2-8-4Z"></path><path d="M4 7v5c0 2 3.6 4 8 4s8-2 8-4V7"></path><path d="M4 12v5c0 2 3.6 4 8 4s8-2 8-4v-5"></path>`};return`
    <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
      ${t[e]??t.dashboard}
    </svg>
  `}function Qe(e,t){return e.render(t)}function j({root:e,state:t,route:n}){let r=e.querySelector(`.app-shell__content`),i=e.querySelector(`.app-shell__sidebar`),a=e.querySelector(`.app-shell__mobile-nav`),o=e.querySelector(`.app-shell__fab-region`);r.innerHTML=Qe(n,t.currentModuleState),n.afterRender?.(r,t.currentModuleState),i.setAttribute(`aria-label`,t.i18n.t(`aria.primaryNavigation`)),a.setAttribute(`aria-label`,t.i18n.t(`aria.mobileNavigation`)),i.innerHTML=`${qe(t)}${Je(t.routes,n)}`,a.innerHTML=Ye(t.routes,n),o.innerHTML=it(t.fab,t.routes,t.i18n),pt(o,t.i18n)}function $e(e,t){return e.dataset.module||t.getState().currentRoute.moduleKey}function et(e){return Object.fromEntries(new FormData(e).entries())}async function tt(e){try{await navigator.clipboard.writeText(Fe(e.language)),S({icon:`📋`,title:e.t(`nutriIa.promptCopiedTitle`),message:e.t(`nutriIa.promptCopiedMessage`)})}catch{S({icon:`⚠️`,title:e.t(`nutriIa.promptCopyFailedTitle`),message:e.t(`nutriIa.promptCopyFailedMessage`)})}}async function nt(e){let t=e.getI18nContext();try{let n=e.logger.getEntries(),r=e.modules.developer?.getState(),i={exportedAt:new Date().toISOString(),versions:r?.versions??{},entries:n};await navigator.clipboard.writeText(JSON.stringify(i,null,2)),S({icon:`📋`,title:t.t(`developer.logsExportedTitle`),message:t.t(`developer.logsExportedMessage`)})}catch{S({icon:`⚠️`,title:t.t(`nutriIa.promptCopyFailedTitle`),message:t.t(`nutriIa.promptCopyFailedMessage`)})}}async function rt({root:e,viewModel:t,importButton:n}){let r=t.getI18nContext();S({icon:`✔`,title:r.t(`toast.mealImported.title`),message:r.t(`toast.mealImported.message`)}),await t.handleAction(`fab`,`showImportSuccess`,{...n.dataset}),j({root:e,state:t.getState(),route:t.getState().currentRoute})}function it(e={},t=[],n){let{isOpen:r,activeDialog:i,today:a,lastImportedMeal:o}=e,s=e.app?.settings??{};return`
    ...
    ${r?at({activeDialog:i,today:a,settings:s,routes:t,lastImportedMeal:o,i18n:n}):``}
  `}function at({activeDialog:e,today:t,settings:n,routes:r,lastImportedMeal:i,i18n:a}){return`
    ...
    <div class="bottom-sheet" role="dialog" aria-modal="true" aria-label="${a.t(`aria.quickActions`)}">
      ${ot({activeDialog:e,today:t,settings:n,routes:r,lastImportedMeal:i,i18n:a})}
    </div>
  `}function ot({activeDialog:e,today:t,settings:n,routes:r,lastImportedMeal:i,i18n:a}){return e===`water`?mt(t,n,a):e===`sleep`?gt(t,n,a):e===`steps`?_t(t,n,a):e===`meal-register`?ct(r,a):e===`nutri-ia`?lt(a):e===`nutri-ia-help`?ut(a):e===`nutri-ia-success`?dt(i,a):st(r,a)}function st(e,t){let n=e.find(e=>e.id===`medication`);return`
  ...
  `}function ct(e,t){let n=e.find(e=>e.id===`favorites`),r=e.find(e=>e.id===`meal-plans`),i=e.find(e=>e.id===`food-library`);return`
    ${M(`🍽`,`fab.registerMeal`,t)}
    <ul class="bottom-sheet__options">
      <li>
  ...
  `}function dt(e,t){let n=e??{};return`
    ${M(`✔`,`toast.mealImported.title`,t)}
  ...
  `}function ft(e,t){return`
    <div class="nutri-ia-preview-card">
      ...
      <dl class="nutri-ia-preview-grid">
        ...
        <div><dt>${t.t(`nutriIa.mealSlotLabel`)}</dt><dd>${y(t.t(k(e.mealType)))}</dd></div>
  ...
  `}function pt(e,t){let n=e?.querySelector(`[data-nutri-ia-input]`);if(!n)return;let r=e.querySelector(`[data-nutri-ia-preview]`),i=e.querySelector(`[data-nutri-ia-import]`),a=()=>{if(!n.value.trim()){r.innerHTML=``,i.disabled=!0;return}let e=He(n.value);if(!e.valid){r.innerHTML=`<p class="nutri-ia-preview-status nutri-ia-preview-status--invalid">${y(t.t(`nutriIa.invalidMessage`))}</p>`,i.disabled=!0;return}r.innerHTML=ft(e.data,t),i.disabled=!1,i.dataset.mealType=e.data.mealType,i.dataset.name=e.data.name,i.dataset.calories=String(e.data.calories),i.dataset.protein=String(e.data.protein),i.dataset.carbs=String(e.data.carbs),i.dataset.fat=String(e.data.fat),i.dataset.fiber=String(e.data.fiber),i.dataset.raw=e.raw};n.addEventListener(`input`,a),a()}function mt(e,t,n){let r=e?.waterMl??0,i=t.waterGoal??0;return`
    ${M(`💧`,`habit.water`,n)}
  ...
  `}var ht=[0,15,30,45];function gt(e,t,n){let r=e?.sleepMinutes??0,i=Math.min(23,Math.floor(r/60)),a=r%60,o=t.sleepGoal??0;return`
    <div class="bottom-sheet__header">
      <button type="button" class="bottom-sheet__back" data-module="fab" data-action="closeDialog" aria-label="${n.t(`common.back`)}">←</button>
      <button type="button" class="bottom-sheet__close" data-module="fab" data-action="close" aria-label="${n.t(`common.close`)}">×</button>
    </div>
    ...
    <form class="module-form" data-module="daily-habits" data-action="setSleep">
      <label>
        ...
        <select name="hours">${vt(0,23,i)}</select>
      </label>
      <label>
        <span>${n.t(`habit.minutes`)}</span>
        <select name="minutes">${yt(ht,a)}</select>
      </label>
      <button type="submit">${n.t(`common.saveChanges`)}</button>
    </form>
  `}function _t(e,t,n){let r=e?.steps??0,i=t.stepGoal??0;return`
    ${M(`👣`,`habit.todaysSteps`,n)}
  ...
  `}function vt(e,t,n){let r=[];for(let i=e;i<=t;i+=1)r.push(`<option value="${i}" ${i===n?`selected`:``}>${i}</option>`);return r.join(``)}function yt(e,t){let n=e.reduce((e,n)=>Math.abs(n-t)<Math.abs(e-t)?n:e,e[0]);return e.map(e=>`<option value="${e}" ${e===n?`selected`:``}>${e}</option>`).join(``)}var bt=class{constructor({backupService:e}){this.backupService=e}exportJson(){return this.backupService.exportJson()}importJson(e){return this.backupService.importJson(e)}};function N(e={}){return{exportText:e.exportText??``,importText:e.importText??``,message:e.message??``,messageParams:e.messageParams??{},error:e.error??``,errorParams:e.errorParams??{}}}var xt=class{constructor({repository:e,eventBus:t}){this.repository=e,this.eventBus=t,this.status=N()}async initialize(){this.status=N(this.status)}getState(){return this.status}async handleAction(e,t={}){if(e===`export`){this.status=N({exportText:await this.repository.exportJson(),message:`message.backupExported`});return}if(e===`import`)try{let e=await this.repository.importJson(t.importText);this.status=N({importText:t.importText,message:`message.backupImported`,messageParams:{stores:e.importedStores.join(`, `)||`message.noStores`}}),this.eventBus.publish(`backup:imported`,e),this.eventBus.publish(`core-mvp:data-changed`)}catch(e){let n=St(e);this.status=N({importText:t.importText,error:n.key,errorParams:n.params})}}};function St(e){let t=e?.message??``;return t.includes(`JSON`)?{key:`error.backupInvalidJson`,params:{}}:t.includes(`unknown object stores`)?{key:`error.backupUnknownStores`,params:{stores:t.split(`:`).slice(1).join(`:`).replace(`.`,``).trim()}}:t.includes(`Unsupported backup format`)?{key:`error.backupUnsupportedFormat`,params:{}}:t.includes(`Backup does not contain stores`)?{key:`error.backupNoStores`,params:{}}:t.includes(`must contain an array of records`)?{key:`error.backupStoreRecords`,params:{}}:{key:`error.backupInvalidJson`,params:{}}}var Ct=class{constructor({repositoryFactory:e}){this.repository=e.getRepository(u.bodyMeasurements)}async list(){return _e(await this.repository.getAll(),`recordedAt`)}async getById(e){return this.repository.getById(e)}async save(e){return this.repository.save(e)}async delete(e){return this.repository.delete(e)}},wt=class{constructor({repository:e,eventBus:t,entityName:n,createEntity:r,validateEntity:i}){this.repository=e,this.eventBus=t,this.entityName=n,this.createEntity=r,this.validateEntity=i,this.records=[],this.editingId=null,this.errors={},this.message=``}async initialize(){await this.load()}async load(){this.records=await this.repository.list()}getState(){return{records:this.records,editingRecord:this.records.find(e=>e.id===this.editingId)??null,errors:this.errors,message:this.message}}async handleAction(e,t={}){if(e===`save`){await this.#e(t);return}if(e===`edit`){this.editingId=t.id,this.errors={},this.message=``;return}if(e===`delete`){await this.repository.delete(t.id),this.editingId=null,this.errors={},this.message=`message.recordDeleted`,await this.load(),this.publishChange();return}e===`cancel`&&(this.editingId=null,this.errors={},this.message=``)}async#e(e){let t=this.editingId?await this.repository.getById(this.editingId):null,n=this.createEntity({...e,id:this.editingId},t),r=this.validateEntity(n);if(Object.keys(r).length>0){this.errors=r,this.message=``;return}await this.repository.save(n),this.editingId=null,this.errors={},this.message=`message.recordSaved`,await this.load(),this.publishChange()}publishChange(){this.eventBus.publish(`${this.entityName}:changed`),this.eventBus.publish(`core-mvp:data-changed`)}};function P(e=`id`){return globalThis.crypto?.randomUUID?`${e}_${globalThis.crypto.randomUUID()}`:`${e}_${Date.now()}_${Math.random().toString(36).slice(2)}`}function Tt(e={},t){let n=T();return{id:t?.id??e.id??P(`body`),recordedAt:e.recordedAt||t?.recordedAt||w(),chest:C(e.chest??t?.chest),waist:C(e.waist??t?.waist),hips:C(e.hips??t?.hips),arm:C(e.arm??t?.arm),thigh:C(e.thigh??t?.thigh),unit:e.unit||t?.unit||`in`,notes:String(e.notes??t?.notes??``).trim(),createdAt:t?.createdAt??n,updatedAt:n}}function Et(e){let t={},n=[e.chest,e.waist,e.hips,e.arm,e.thigh];return e.recordedAt||(t.recordedAt=`validation.dateRequired`),n.some(e=>e!==null&&e>0)||(t.measurements=`validation.measurementRequired`),t}var Dt=class extends wt{constructor({repository:e,eventBus:t}){super({repository:e,eventBus:t,entityName:`body-measurements`,createEntity:Tt,validateEntity:Et})}},Ot=class{constructor({repositoryFactory:e}){this.repository=e.getRepository(u.dailyHabits)}async getByDate(e){return this.repository.getByIndex(`date`,e)}async getToday(){return this.getByDate(w())}async save(e){return this.repository.save(e)}};function kt(e={},t){let n=T();return{id:t?.id??e.id??P(`daily-habit`),date:e.date||t?.date||w(),waterMl:At(e.waterMl??t?.waterMl),sleepMinutes:At(e.sleepMinutes??t?.sleepMinutes),steps:At(e.steps??t?.steps),createdAt:t?.createdAt??n,updatedAt:n}}function At(e){let t=Number(e);return Number.isFinite(t)&&t>0?Math.round(t):0}var jt=class{constructor({repository:e,eventBus:t}){this.repository=e,this.eventBus=t,this.today=null}async initialize(){this.today=await this.repository.getToday()??null}getState(){return{today:this.today}}async handleAction(e,t={}){if(e===`addWater`){let e=Number(t.amount)||0;if(e!==0){let t=Math.max(0,(this.today?.waterMl??0)+e);await this.#e({waterMl:t})}return}if(e===`setSleep`){let e=Number(t.hours)||0,n=Number(t.minutes)||0;await this.#e({sleepMinutes:e*60+n});return}e===`setSteps`&&await this.#e({steps:Number(t.steps)||0})}async#e(e){let t=kt({...this.today,...e},this.today);await this.repository.save(t),this.today=t,this.eventBus.publish(`daily-habits:changed`),this.eventBus.publish(`core-mvp:data-changed`)}};function Mt({meals:e,weights:t,bodyMeasurements:n,medicationApplications:r,dailyHabits:i}){let a=w(),o=e.filter(e=>e.mealDate===a);return{mealCount:e.length,todayMealCount:o.length,todayCalories:o.reduce((e,t)=>e+(t.calories??0),0),todayProtein:o.reduce((e,t)=>e+(t.protein??0),0),weightCount:t.length,bodyMeasurementCount:n.length,medicationApplicationCount:r.length,activityCount:e.length+t.length+n.length+r.length,latestMeal:e[0]??null,latestWeight:t[0]??null,latestBodyMeasurement:n[0]??null,latestMedicationApplication:r[0]??null,dailyHabits:i??null}}var Nt=class{constructor({mealJournalRepository:e,weightTrackingRepository:t,bodyMeasurementsRepository:n,medicationRepository:r,dailyHabitsRepository:i}){this.mealJournalRepository=e,this.weightTrackingRepository=t,this.bodyMeasurementsRepository=n,this.medicationRepository=r,this.dailyHabitsRepository=i}async getSummary(){let[e,t,n,r,i]=await Promise.all([this.mealJournalRepository.list(),this.weightTrackingRepository.list(),this.bodyMeasurementsRepository.list(),this.medicationRepository.list(),this.dailyHabitsRepository.getToday()]);return Mt({meals:e,weights:t,bodyMeasurements:n,medicationApplications:r,dailyHabits:i})}},Pt=class{constructor({repository:e}){this.repository=e,this.summary=null}async initialize(){await this.refresh()}async refresh(){this.summary=await this.repository.getSummary()}getState(){return{summary:this.summary}}async handleAction(){await this.refresh()}},Ft=[{foodCode:`BANANA_PRATA`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:68,protein:1,carbs:18,fat:.1,fiber:2,names:{en:`Banana (Prata)`,"pt-BR":`Banana Prata`}},{foodCode:`BANANA_NANICA`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:89,protein:1.1,carbs:23,fat:.3,fiber:2.6,names:{en:`Banana (Nanica)`,"pt-BR":`Banana Nanica`}},{foodCode:`BANANA_MACA`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:61,protein:.8,carbs:16,fat:.1,fiber:1.7,names:{en:`Banana (Apple Banana)`,"pt-BR":`Banana Maçã`}},{foodCode:`APPLE`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:68,protein:.3,carbs:18,fat:.2,fiber:3,names:{en:`Apple`,"pt-BR":`Maçã`}},{foodCode:`ORANGE`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:62,protein:1.2,carbs:15,fat:.2,fiber:3,names:{en:`Orange`,"pt-BR":`Laranja`}},{foodCode:`PAPAYA`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:43,protein:.5,carbs:11,fat:.1,fiber:1.7,names:{en:`Papaya`,"pt-BR":`Mamão`}},{foodCode:`MANGO`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:60,protein:.8,carbs:15,fat:.4,fiber:1.6,names:{en:`Mango`,"pt-BR":`Manga`}},{foodCode:`PINEAPPLE`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:50,protein:.5,carbs:13,fat:.1,fiber:1,names:{en:`Pineapple`,"pt-BR":`Abacaxi`}},{foodCode:`WATERMELON`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:30,protein:.6,carbs:8,fat:.2,fiber:.4,names:{en:`Watermelon`,"pt-BR":`Melancia`}},{foodCode:`MELON`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:29,protein:.7,carbs:7,fat:.1,fiber:.5,names:{en:`Melon`,"pt-BR":`Melão`}},{foodCode:`STRAWBERRY`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:30,protein:.9,carbs:7,fat:.3,fiber:1.7,names:{en:`Strawberry`,"pt-BR":`Morango`}},{foodCode:`GRAPE`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:53,protein:.5,carbs:14,fat:.2,fiber:.9,names:{en:`Grape`,"pt-BR":`Uva`}},{foodCode:`PEAR`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:86,protein:.6,carbs:22,fat:.2,fiber:4,names:{en:`Pear`,"pt-BR":`Pera`}},{foodCode:`KIWI`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:42,protein:.8,carbs:10,fat:.4,fiber:2.1,names:{en:`Kiwi`,"pt-BR":`Kiwi`}},{foodCode:`AVOCADO`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:96,protein:1.2,carbs:6,fat:8.4,fiber:6.3,names:{en:`Avocado`,"pt-BR":`Abacate`}},{foodCode:`LEMON`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:17,protein:.4,carbs:5,fat:.2,fiber:1.7,names:{en:`Lemon`,"pt-BR":`Limão`}},{foodCode:`TANGERINE`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:46,protein:.7,carbs:12,fat:.2,fiber:1.7,names:{en:`Tangerine`,"pt-BR":`Tangerina`}},{foodCode:`PEACH`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:51,protein:1,carbs:12,fat:.3,fiber:2,names:{en:`Peach`,"pt-BR":`Pêssego`}},{foodCode:`PLUM`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:30,protein:.5,carbs:8,fat:.2,fiber:.9,names:{en:`Plum`,"pt-BR":`Ameixa`}},{foodCode:`FIG`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:37,protein:.4,carbs:10,fat:.2,fiber:1.5,names:{en:`Fig`,"pt-BR":`Figo`}},{foodCode:`GUAVA`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:54,protein:1.1,carbs:12,fat:.5,fiber:5,names:{en:`Guava`,"pt-BR":`Goiaba`}},{foodCode:`PASSION_FRUIT`,category:`fruits`,servingSize:1,servingUnit:`unit`,calories:33,protein:.8,carbs:8,fat:.2,fiber:.9,names:{en:`Passion Fruit`,"pt-BR":`Maracujá`}},{foodCode:`COCONUT`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:354,protein:3.3,carbs:15,fat:33,fiber:9,names:{en:`Coconut`,"pt-BR":`Coco`}},{foodCode:`DRIED_BANANA`,category:`fruits`,servingSize:30,servingUnit:`g`,calories:92,protein:1,carbs:22,fat:.3,fiber:2.3,names:{en:`Dried Banana`,"pt-BR":`Banana Passa`}},{foodCode:`CHERRY`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:63,protein:1.1,carbs:16,fat:.2,fiber:2.1,names:{en:`Cherry`,"pt-BR":`Cereja`}},{foodCode:`BLACKBERRY`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:43,protein:1.4,carbs:10,fat:.5,fiber:5.3,names:{en:`Blackberry`,"pt-BR":`Amora`}},{foodCode:`BLUEBERRY`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:57,protein:.7,carbs:14,fat:.3,fiber:2.4,names:{en:`Blueberry`,"pt-BR":`Mirtilo`}},{foodCode:`RASPBERRY`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:52,protein:1.2,carbs:12,fat:.7,fiber:6.5,names:{en:`Raspberry`,"pt-BR":`Framboesa`}},{foodCode:`LETTUCE`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:15,protein:1.4,carbs:2.9,fat:.2,fiber:1.3,names:{en:`Lettuce`,"pt-BR":`Alface`}},{foodCode:`TOMATO`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:18,protein:.9,carbs:3.9,fat:.2,fiber:1.2,names:{en:`Tomato`,"pt-BR":`Tomate`}},{foodCode:`BROCCOLI`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:34,protein:2.8,carbs:7,fat:.4,fiber:2.6,names:{en:`Broccoli`,"pt-BR":`Brócolis`}},{foodCode:`CARROT`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:41,protein:.9,carbs:10,fat:.2,fiber:2.8,names:{en:`Carrot`,"pt-BR":`Cenoura`}},{foodCode:`BEETROOT`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:43,protein:1.6,carbs:10,fat:.2,fiber:2.8,names:{en:`Beetroot`,"pt-BR":`Beterraba`}},{foodCode:`ZUCCHINI`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:17,protein:1.2,carbs:3.1,fat:.3,fiber:1,names:{en:`Zucchini`,"pt-BR":`Abobrinha`}},{foodCode:`PUMPKIN`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:26,protein:1,carbs:6.5,fat:.1,fiber:.5,names:{en:`Pumpkin`,"pt-BR":`Abóbora`}},{foodCode:`CUCUMBER`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:15,protein:.7,carbs:3.6,fat:.1,fiber:.5,names:{en:`Cucumber`,"pt-BR":`Pepino`}},{foodCode:`SPINACH`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:23,protein:2.9,carbs:3.6,fat:.4,fiber:2.2,names:{en:`Spinach`,"pt-BR":`Espinafre`}},{foodCode:`CAULIFLOWER`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:25,protein:1.9,carbs:5,fat:.3,fiber:2,names:{en:`Cauliflower`,"pt-BR":`Couve-flor`}},{foodCode:`ONION`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:40,protein:1.1,carbs:9.3,fat:.1,fiber:1.7,names:{en:`Onion`,"pt-BR":`Cebola`}},{foodCode:`GARLIC`,category:`vegetables`,servingSize:10,servingUnit:`g`,calories:15,protein:.6,carbs:3.3,fat:.05,fiber:.2,names:{en:`Garlic`,"pt-BR":`Alho`}},{foodCode:`BELL_PEPPER`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:31,protein:1,carbs:6,fat:.3,fiber:2.1,names:{en:`Bell Pepper`,"pt-BR":`Pimentão`}},{foodCode:`EGGPLANT`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:25,protein:1,carbs:6,fat:.2,fiber:3,names:{en:`Eggplant`,"pt-BR":`Berinjela`}},{foodCode:`OKRA`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:33,protein:1.9,carbs:7,fat:.2,fiber:3.2,names:{en:`Okra`,"pt-BR":`Quiabo`}},{foodCode:`KALE`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:35,protein:2.9,carbs:4.4,fat:1.5,fiber:3.6,names:{en:`Kale`,"pt-BR":`Couve`}},{foodCode:`CABBAGE`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:25,protein:1.3,carbs:5.8,fat:.1,fiber:2.5,names:{en:`Cabbage`,"pt-BR":`Repolho`}},{foodCode:`CHAYOTE`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:19,protein:.8,carbs:4.5,fat:.1,fiber:1.7,names:{en:`Chayote`,"pt-BR":`Chuchu`}},{foodCode:`MUSHROOM`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:22,protein:3.1,carbs:3.3,fat:.3,fiber:1,names:{en:`Mushroom`,"pt-BR":`Cogumelo`}},{foodCode:`GREEN_BEANS`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:31,protein:1.8,carbs:7,fat:.1,fiber:3.4,names:{en:`Green Beans`,"pt-BR":`Vagem`}},{foodCode:`ARUGULA`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:25,protein:2.6,carbs:3.7,fat:.7,fiber:1.6,names:{en:`Arugula`,"pt-BR":`Rúcula`}},{foodCode:`CHARD`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:19,protein:1.8,carbs:3.7,fat:.2,fiber:1.6,names:{en:`Chard`,"pt-BR":`Acelga`}},{foodCode:`CELERY`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:16,protein:.7,carbs:3,fat:.2,fiber:1.6,names:{en:`Celery`,"pt-BR":`Salsão`}},{foodCode:`RADISH`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:16,protein:.7,carbs:3.4,fat:.1,fiber:1.6,names:{en:`Radish`,"pt-BR":`Rabanete`}},{foodCode:`BLACK_BEANS`,category:`legumes`,servingSize:100,servingUnit:`g`,calories:77,protein:4.5,carbs:14,fat:.5,fiber:8.4,names:{en:`Black Beans`,"pt-BR":`Feijão Preto`}},{foodCode:`CARIOCA_BEANS`,category:`legumes`,servingSize:100,servingUnit:`g`,calories:76,protein:4.8,carbs:13.6,fat:.5,fiber:8.5,names:{en:`Carioca Beans`,"pt-BR":`Feijão Carioca`}},{foodCode:`LENTILS`,category:`legumes`,servingSize:100,servingUnit:`g`,calories:93,protein:6.3,carbs:16,fat:.4,fiber:7.3,names:{en:`Lentils`,"pt-BR":`Lentilha`}},{foodCode:`CHICKPEAS`,category:`legumes`,servingSize:100,servingUnit:`g`,calories:121,protein:6.6,carbs:20,fat:1.9,fiber:6,names:{en:`Chickpeas`,"pt-BR":`Grão-de-Bico`}},{foodCode:`PEAS`,category:`legumes`,servingSize:100,servingUnit:`g`,calories:84,protein:5.4,carbs:15,fat:.2,fiber:5.1,names:{en:`Peas`,"pt-BR":`Ervilha`}},{foodCode:`SOYBEANS`,category:`legumes`,servingSize:100,servingUnit:`g`,calories:141,protein:12.4,carbs:9.9,fat:6.4,fiber:6,names:{en:`Soybeans`,"pt-BR":`Soja`}},{foodCode:`WHITE_BEANS`,category:`legumes`,servingSize:100,servingUnit:`g`,calories:87,protein:5.2,carbs:15.7,fat:.4,fiber:6.3,names:{en:`White Beans`,"pt-BR":`Feijão Branco`}},{foodCode:`FAVA_BEANS`,category:`legumes`,servingSize:100,servingUnit:`g`,calories:88,protein:7.6,carbs:13,fat:.4,fiber:5.4,names:{en:`Fava Beans`,"pt-BR":`Fava`}},{foodCode:`WHITE_RICE`,category:`grains`,servingSize:100,servingUnit:`g`,calories:128,protein:2.5,carbs:28,fat:.2,fiber:1.6,names:{en:`White Rice`,"pt-BR":`Arroz Branco`}},{foodCode:`BROWN_RICE`,category:`grains`,servingSize:100,servingUnit:`g`,calories:123,protein:2.6,carbs:25.8,fat:1,fiber:2.7,names:{en:`Brown Rice`,"pt-BR":`Arroz Integral`}},{foodCode:`OATS`,category:`grains`,servingSize:30,servingUnit:`g`,calories:117,protein:4.2,carbs:20,fat:2.4,fiber:3,names:{en:`Oats`,"pt-BR":`Aveia`}},{foodCode:`GRANOLA`,category:`grains`,servingSize:30,servingUnit:`g`,calories:130,protein:3,carbs:19,fat:5,fiber:2.5,names:{en:`Granola`,"pt-BR":`Granola`}},{foodCode:`CORN`,category:`grains`,servingSize:100,servingUnit:`g`,calories:98,protein:3.4,carbs:21,fat:1.5,fiber:2.4,names:{en:`Corn`,"pt-BR":`Milho`}},{foodCode:`QUINOA`,category:`grains`,servingSize:100,servingUnit:`g`,calories:120,protein:4.4,carbs:21.3,fat:1.9,fiber:2.8,names:{en:`Quinoa`,"pt-BR":`Quinoa`}},{foodCode:`WHOLE_WHEAT_PASTA`,category:`grains`,servingSize:100,servingUnit:`g`,calories:124,protein:5.3,carbs:26,fat:.9,fiber:3.9,names:{en:`Whole Wheat Pasta`,"pt-BR":`Macarrão Integral`}},{foodCode:`WHITE_PASTA`,category:`grains`,servingSize:100,servingUnit:`g`,calories:131,protein:5,carbs:25,fat:1.1,fiber:1.8,names:{en:`White Pasta`,"pt-BR":`Macarrão Branco`}},{foodCode:`POLENTA`,category:`grains`,servingSize:100,servingUnit:`g`,calories:85,protein:2,carbs:18,fat:.5,fiber:1,names:{en:`Polenta`,"pt-BR":`Polenta`}},{foodCode:`COUSCOUS`,category:`grains`,servingSize:100,servingUnit:`g`,calories:112,protein:3.8,carbs:23,fat:.2,fiber:1.4,names:{en:`Couscous`,"pt-BR":`Cuscuz de Milho`}},{foodCode:`BARLEY`,category:`grains`,servingSize:100,servingUnit:`g`,calories:123,protein:2.3,carbs:28,fat:.4,fiber:3.8,names:{en:`Barley`,"pt-BR":`Cevada`}},{foodCode:`RICE_FLOUR`,category:`grains`,servingSize:30,servingUnit:`g`,calories:109,protein:1.8,carbs:24,fat:.2,fiber:.4,names:{en:`Rice Flour`,"pt-BR":`Farinha de Arroz`}},{foodCode:`RYE`,category:`grains`,servingSize:100,servingUnit:`g`,calories:83,protein:3,carbs:18,fat:.6,fiber:3,names:{en:`Rye`,"pt-BR":`Centeio`}},{foodCode:`BUCKWHEAT`,category:`grains`,servingSize:100,servingUnit:`g`,calories:92,protein:3.4,carbs:20,fat:.6,fiber:2.7,names:{en:`Buckwheat`,"pt-BR":`Trigo Sarraceno`}},{foodCode:`POTATO`,category:`roots`,servingSize:100,servingUnit:`g`,calories:87,protein:1.9,carbs:20,fat:.1,fiber:1.8,names:{en:`Potato`,"pt-BR":`Batata`}},{foodCode:`SWEET_POTATO`,category:`roots`,servingSize:100,servingUnit:`g`,calories:86,protein:1.6,carbs:20,fat:.1,fiber:3,names:{en:`Sweet Potato`,"pt-BR":`Batata Doce`}},{foodCode:`CASSAVA`,category:`roots`,servingSize:100,servingUnit:`g`,calories:125,protein:.6,carbs:30,fat:.3,fiber:1.8,names:{en:`Cassava`,"pt-BR":`Mandioca`}},{foodCode:`YAM`,category:`roots`,servingSize:100,servingUnit:`g`,calories:116,protein:1.5,carbs:27,fat:.2,fiber:4.1,names:{en:`Yam`,"pt-BR":`Inhame`}},{foodCode:`TARO`,category:`roots`,servingSize:100,servingUnit:`g`,calories:112,protein:1.5,carbs:26,fat:.2,fiber:4.1,names:{en:`Taro`,"pt-BR":`Cará`}},{foodCode:`MASHED_POTATO`,category:`roots`,servingSize:100,servingUnit:`g`,calories:105,protein:2,carbs:16,fat:4,fiber:1.5,names:{en:`Mashed Potato`,"pt-BR":`Purê de Batata`}},{foodCode:`PURPLE_SWEET_POTATO`,category:`roots`,servingSize:100,servingUnit:`g`,calories:90,protein:1.8,carbs:21,fat:.2,fiber:3.3,names:{en:`Purple Sweet Potato`,"pt-BR":`Batata Doce Roxa`}},{foodCode:`PERUVIAN_CARROT`,category:`roots`,servingSize:100,servingUnit:`g`,calories:80,protein:1.1,carbs:18,fat:.3,fiber:1.5,names:{en:`Peruvian Carrot`,"pt-BR":`Batata Baroa`}},{foodCode:`PEANUTS`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:170,protein:7.3,carbs:6,fat:14,fiber:2.4,names:{en:`Peanuts`,"pt-BR":`Amendoim`}},{foodCode:`CASHEWS`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:165,protein:5.2,carbs:9,fat:13,fiber:1,names:{en:`Cashews`,"pt-BR":`Castanha de Caju`}},{foodCode:`BRAZIL_NUTS`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:199,protein:4.3,carbs:3.6,fat:20,fiber:2.3,names:{en:`Brazil Nuts`,"pt-BR":`Castanha do Pará`}},{foodCode:`WALNUTS`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:196,protein:4.6,carbs:4.1,fat:19.6,fiber:2,names:{en:`Walnuts`,"pt-BR":`Noz`}},{foodCode:`ALMONDS`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:174,protein:6.3,carbs:6.1,fat:15,fiber:3.5,names:{en:`Almonds`,"pt-BR":`Amêndoas`}},{foodCode:`PISTACHIOS`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:168,protein:6,carbs:8,fat:13.4,fiber:3,names:{en:`Pistachios`,"pt-BR":`Pistache`}},{foodCode:`CHIA_SEEDS`,category:`nuts`,servingSize:15,servingUnit:`tablespoon`,calories:70,protein:2.4,carbs:6,fat:4.4,fiber:5.2,names:{en:`Chia Seeds`,"pt-BR":`Semente de Chia`}},{foodCode:`FLAXSEED`,category:`nuts`,servingSize:15,servingUnit:`tablespoon`,calories:75,protein:2.6,carbs:4,fat:5.9,fiber:4.1,names:{en:`Flaxseed`,"pt-BR":`Linhaça`}},{foodCode:`SUNFLOWER_SEEDS`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:175,protein:6.1,carbs:6,fat:15.5,fiber:2.7,names:{en:`Sunflower Seeds`,"pt-BR":`Semente de Girassol`}},{foodCode:`PUMPKIN_SEEDS`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:165,protein:9,carbs:4.2,fat:14,fiber:1.8,names:{en:`Pumpkin Seeds`,"pt-BR":`Semente de Abóbora`}},{foodCode:`MACADAMIA`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:215,protein:2.2,carbs:4,fat:22.8,fiber:2.4,names:{en:`Macadamia`,"pt-BR":`Macadâmia`}},{foodCode:`PINE_NUTS`,category:`nuts`,servingSize:30,servingUnit:`g`,calories:190,protein:4,carbs:3.7,fat:19,fiber:1,names:{en:`Pine Nuts`,"pt-BR":`Pinoli`}},{foodCode:`CHICKEN_BREAST`,category:`chicken`,servingSize:100,servingUnit:`g`,calories:165,protein:31,carbs:0,fat:3.6,fiber:0,names:{en:`Chicken Breast`,"pt-BR":`Peito de Frango`}},{foodCode:`CHICKEN_THIGH`,category:`chicken`,servingSize:100,servingUnit:`g`,calories:209,protein:26,carbs:0,fat:10.9,fiber:0,names:{en:`Chicken Thigh`,"pt-BR":`Coxa de Frango`}},{foodCode:`CHICKEN_DRUMSTICK`,category:`chicken`,servingSize:100,servingUnit:`g`,calories:172,protein:28,carbs:0,fat:5.7,fiber:0,names:{en:`Chicken Drumstick`,"pt-BR":`Sobrecoxa de Frango`}},{foodCode:`TURKEY_BREAST`,category:`chicken`,servingSize:100,servingUnit:`g`,calories:135,protein:30,carbs:0,fat:1,fiber:0,names:{en:`Turkey Breast`,"pt-BR":`Peito de Peru`}},{foodCode:`LEAN_BEEF`,category:`meat`,servingSize:100,servingUnit:`g`,calories:172,protein:27,carbs:0,fat:6.5,fiber:0,names:{en:`Lean Beef`,"pt-BR":`Carne Bovina Magra`}},{foodCode:`SIRLOIN`,category:`meat`,servingSize:100,servingUnit:`g`,calories:201,protein:27,carbs:0,fat:9.6,fiber:0,names:{en:`Sirloin`,"pt-BR":`Alcatra`}},{foodCode:`RUMP_STEAK`,category:`meat`,servingSize:100,servingUnit:`g`,calories:179,protein:28,carbs:0,fat:7,fiber:0,names:{en:`Rump Steak`,"pt-BR":`Patinho`}},{foodCode:`GROUND_BEEF_LEAN`,category:`meat`,servingSize:100,servingUnit:`g`,calories:172,protein:26,carbs:0,fat:7,fiber:0,names:{en:`Lean Ground Beef`,"pt-BR":`Carne Moída Magra`}},{foodCode:`GROUND_BEEF_REGULAR`,category:`meat`,servingSize:100,servingUnit:`g`,calories:254,protein:25,carbs:0,fat:17,fiber:0,names:{en:`Ground Beef`,"pt-BR":`Carne Moída`}},{foodCode:`PORK_LOIN`,category:`meat`,servingSize:100,servingUnit:`g`,calories:195,protein:28,carbs:0,fat:8.5,fiber:0,names:{en:`Pork Loin`,"pt-BR":`Lombo Suíno`}},{foodCode:`PORK_TENDERLOIN`,category:`meat`,servingSize:100,servingUnit:`g`,calories:143,protein:26,carbs:0,fat:3.5,fiber:0,names:{en:`Pork Tenderloin`,"pt-BR":`Filé Suíno`}},{foodCode:`BACON`,category:`meat`,servingSize:30,servingUnit:`g`,calories:161,protein:11,carbs:.4,fat:12.5,fiber:0,names:{en:`Bacon`,"pt-BR":`Bacon`}},{foodCode:`BEEF_LIVER`,category:`meat`,servingSize:100,servingUnit:`g`,calories:175,protein:26.5,carbs:3.9,fat:4.9,fiber:0,names:{en:`Beef Liver`,"pt-BR":`Fígado Bovino`}},{foodCode:`FILET_MIGNON`,category:`meat`,servingSize:100,servingUnit:`g`,calories:191,protein:29,carbs:0,fat:7.6,fiber:0,names:{en:`Filet Mignon`,"pt-BR":`Filé Mignon`}},{foodCode:`RIBEYE`,category:`meat`,servingSize:100,servingUnit:`g`,calories:250,protein:25,carbs:0,fat:16,fiber:0,names:{en:`Ribeye`,"pt-BR":`Bife Ancho`}},{foodCode:`LAMB`,category:`meat`,servingSize:100,servingUnit:`g`,calories:258,protein:25,carbs:0,fat:17,fiber:0,names:{en:`Lamb`,"pt-BR":`Cordeiro`}},{foodCode:`VEAL`,category:`meat`,servingSize:100,servingUnit:`g`,calories:172,protein:29,carbs:0,fat:5.4,fiber:0,names:{en:`Veal`,"pt-BR":`Vitela`}},{foodCode:`DUCK`,category:`meat`,servingSize:100,servingUnit:`g`,calories:337,protein:19,carbs:0,fat:28,fiber:0,names:{en:`Duck`,"pt-BR":`Pato`}},{foodCode:`SALMON`,category:`fish`,servingSize:100,servingUnit:`g`,calories:208,protein:20,carbs:0,fat:13,fiber:0,names:{en:`Salmon`,"pt-BR":`Salmão`}},{foodCode:`TUNA`,category:`fish`,servingSize:100,servingUnit:`g`,calories:132,protein:28,carbs:0,fat:1.3,fiber:0,names:{en:`Tuna`,"pt-BR":`Atum`}},{foodCode:`TILAPIA`,category:`fish`,servingSize:100,servingUnit:`g`,calories:128,protein:26,carbs:0,fat:2.7,fiber:0,names:{en:`Tilapia`,"pt-BR":`Tilápia`}},{foodCode:`SARDINE`,category:`fish`,servingSize:100,servingUnit:`g`,calories:208,protein:25,carbs:0,fat:11,fiber:0,names:{en:`Sardine`,"pt-BR":`Sardinha`}},{foodCode:`COD`,category:`fish`,servingSize:100,servingUnit:`g`,calories:105,protein:23,carbs:0,fat:.9,fiber:0,names:{en:`Cod`,"pt-BR":`Bacalhau`}},{foodCode:`SHRIMP`,category:`fish`,servingSize:100,servingUnit:`g`,calories:99,protein:24,carbs:.2,fat:.3,fiber:0,names:{en:`Shrimp`,"pt-BR":`Camarão`}},{foodCode:`HAKE`,category:`fish`,servingSize:100,servingUnit:`g`,calories:90,protein:18,carbs:0,fat:1.3,fiber:0,names:{en:`Hake`,"pt-BR":`Merluza`}},{foodCode:`MACKEREL`,category:`fish`,servingSize:100,servingUnit:`g`,calories:205,protein:19,carbs:0,fat:14,fiber:0,names:{en:`Mackerel`,"pt-BR":`Cavala`}},{foodCode:`CANNED_TUNA_WATER`,category:`fish`,servingSize:100,servingUnit:`g`,calories:116,protein:26,carbs:0,fat:.8,fiber:0,names:{en:`Canned Tuna (in Water)`,"pt-BR":`Atum em Lata (Água)`}},{foodCode:`CANNED_TUNA_OIL`,category:`fish`,servingSize:100,servingUnit:`g`,calories:198,protein:25,carbs:0,fat:10,fiber:0,names:{en:`Canned Tuna (in Oil)`,"pt-BR":`Atum em Lata (Óleo)`}},{foodCode:`TROUT`,category:`fish`,servingSize:100,servingUnit:`g`,calories:148,protein:21,carbs:0,fat:6.6,fiber:0,names:{en:`Trout`,"pt-BR":`Truta`}},{foodCode:`ANCHOVY`,category:`fish`,servingSize:30,servingUnit:`g`,calories:37,protein:5.7,carbs:0,fat:1.4,fiber:0,names:{en:`Anchovy`,"pt-BR":`Anchova`}},{foodCode:`WHOLE_EGG`,category:`eggs`,servingSize:1,servingUnit:`unit`,calories:78,protein:6.3,carbs:.6,fat:5.3,fiber:0,names:{en:`Whole Egg`,"pt-BR":`Ovo Inteiro`}},{foodCode:`EGG_WHITE`,category:`eggs`,servingSize:1,servingUnit:`unit`,calories:17,protein:3.6,carbs:.2,fat:.1,fiber:0,names:{en:`Egg White`,"pt-BR":`Clara de Ovo`}},{foodCode:`EGG_YOLK`,category:`eggs`,servingSize:1,servingUnit:`unit`,calories:55,protein:2.7,carbs:.6,fat:4.5,fiber:0,names:{en:`Egg Yolk`,"pt-BR":`Gema de Ovo`}},{foodCode:`WHOLE_MILK`,category:`dairy`,servingSize:200,servingUnit:`mL`,calories:122,protein:6.4,carbs:9.6,fat:6.6,fiber:0,names:{en:`Whole Milk`,"pt-BR":`Leite Integral`}},{foodCode:`SKIM_MILK`,category:`dairy`,servingSize:200,servingUnit:`mL`,calories:70,protein:6.8,carbs:10,fat:.4,fiber:0,names:{en:`Skim Milk`,"pt-BR":`Leite Desnatado`}},{foodCode:`GREEK_YOGURT`,category:`dairy`,servingSize:100,servingUnit:`g`,calories:97,protein:9,carbs:3.9,fat:5,fiber:0,names:{en:`Greek Yogurt`,"pt-BR":`Iogurte Grego`}},{foodCode:`NATURAL_YOGURT`,category:`dairy`,servingSize:100,servingUnit:`g`,calories:61,protein:3.5,carbs:4.7,fat:3.3,fiber:0,names:{en:`Natural Yogurt`,"pt-BR":`Iogurte Natural`}},{foodCode:`MOZZARELLA`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:90,protein:6.7,carbs:.7,fat:6.9,fiber:0,names:{en:`Mozzarella`,"pt-BR":`Mussarela`}},{foodCode:`MINAS_CHEESE`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:72,protein:5.1,carbs:.9,fat:5.4,fiber:0,names:{en:`Minas Cheese`,"pt-BR":`Queijo Minas`}},{foodCode:`PARMESAN`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:130,protein:11.6,carbs:1,fat:8.6,fiber:0,names:{en:`Parmesan`,"pt-BR":`Queijo Parmesão`}},{foodCode:`CREAM_CHEESE`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:99,protein:2.1,carbs:1.5,fat:9.9,fiber:0,names:{en:`Cream Cheese`,"pt-BR":`Cream Cheese`}},{foodCode:`COTTAGE_CHEESE`,category:`dairy`,servingSize:100,servingUnit:`g`,calories:98,protein:11,carbs:3.4,fat:4.3,fiber:0,names:{en:`Cottage Cheese`,"pt-BR":`Queijo Cottage`}},{foodCode:`BUTTER`,category:`dairy`,servingSize:10,servingUnit:`tablespoon`,calories:72,protein:.1,carbs:0,fat:8.1,fiber:0,names:{en:`Butter`,"pt-BR":`Manteiga`}},{foodCode:`REQUEIJAO`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:69,protein:2.4,carbs:1.1,fat:6,fiber:0,names:{en:`Requeijão`,"pt-BR":`Requeijão`}},{foodCode:`PRATO_CHEESE`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:107,protein:6.7,carbs:.6,fat:8.7,fiber:0,names:{en:`Prato Cheese`,"pt-BR":`Queijo Prato`}},{foodCode:`CONDENSED_MILK`,category:`dairy`,servingSize:15,servingUnit:`tablespoon`,calories:49,protein:1.2,carbs:8.3,fat:1.3,fiber:0,names:{en:`Condensed Milk`,"pt-BR":`Leite Condensado`}},{foodCode:`HEAVY_CREAM`,category:`dairy`,servingSize:30,servingUnit:`mL`,calories:100,protein:.7,carbs:1,fat:10.7,fiber:0,names:{en:`Heavy Cream`,"pt-BR":`Creme de Leite`}},{foodCode:`WHIPPED_CREAM`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:103,protein:.6,carbs:3,fat:10,fiber:0,names:{en:`Whipped Cream`,"pt-BR":`Chantilly`}},{foodCode:`RICOTTA`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:38,protein:3.3,carbs:1,fat:2.5,fiber:0,names:{en:`Ricotta`,"pt-BR":`Ricota`}},{foodCode:`FRENCH_BREAD`,category:`bread`,servingSize:1,servingUnit:`unit`,calories:150,protein:4.5,carbs:28,fat:1.5,fiber:1.4,names:{en:`French Bread`,"pt-BR":`Pão Francês`}},{foodCode:`WHOLE_WHEAT_BREAD`,category:`bread`,servingSize:1,servingUnit:`slice`,calories:62,protein:2.7,carbs:11,fat:1,fiber:1.9,names:{en:`Whole Wheat Bread`,"pt-BR":`Pão Integral`}},{foodCode:`TOAST`,category:`bread`,servingSize:1,servingUnit:`slice`,calories:30,protein:1,carbs:5.5,fat:.4,fiber:.4,names:{en:`Toast`,"pt-BR":`Torrada`}},{foodCode:`TAPIOCA`,category:`bread`,servingSize:1,servingUnit:`unit`,calories:108,protein:.1,carbs:26,fat:.1,fiber:.5,names:{en:`Tapioca`,"pt-BR":`Tapioca`}},{foodCode:`HAMBURGER_BUN`,category:`bread`,servingSize:1,servingUnit:`unit`,calories:145,protein:4.5,carbs:26,fat:2.3,fiber:1.2,names:{en:`Hamburger Bun`,"pt-BR":`Pão de Hambúrguer`}},{foodCode:`HOT_DOG_BUN`,category:`bread`,servingSize:1,servingUnit:`unit`,calories:130,protein:4,carbs:24,fat:2,fiber:1,names:{en:`Hot Dog Bun`,"pt-BR":`Pão de Cachorro-Quente`}},{foodCode:`PITA_BREAD`,category:`bread`,servingSize:1,servingUnit:`unit`,calories:165,protein:5.5,carbs:33,fat:.7,fiber:1.3,names:{en:`Pita Bread`,"pt-BR":`Pão Pita`}},{foodCode:`CIABATTA`,category:`bread`,servingSize:1,servingUnit:`unit`,calories:210,protein:7,carbs:40,fat:2,fiber:1.8,names:{en:`Ciabatta`,"pt-BR":`Ciabatta`}},{foodCode:`BAGEL`,category:`bread`,servingSize:1,servingUnit:`unit`,calories:245,protein:9.5,carbs:48,fat:1.4,fiber:2,names:{en:`Bagel`,"pt-BR":`Bagel`}},{foodCode:`CROISSANT`,category:`bread`,servingSize:1,servingUnit:`unit`,calories:231,protein:4.7,carbs:26,fat:12,fiber:1.5,names:{en:`Croissant`,"pt-BR":`Croissant`}},{foodCode:`WHEY_PROTEIN`,category:`supplements`,servingSize:1,servingUnit:`scoop`,calories:120,protein:24,carbs:3,fat:1.5,fiber:0,names:{en:`Whey Protein`,"pt-BR":`Whey Protein`}},{foodCode:`CASEIN`,category:`supplements`,servingSize:1,servingUnit:`scoop`,calories:110,protein:24,carbs:2,fat:1,fiber:0,names:{en:`Casein`,"pt-BR":`Caseína`}},{foodCode:`CREATINE`,category:`supplements`,servingSize:1,servingUnit:`scoop`,calories:0,protein:0,carbs:0,fat:0,fiber:0,names:{en:`Creatine`,"pt-BR":`Creatina`}},{foodCode:`BCAA`,category:`supplements`,servingSize:1,servingUnit:`scoop`,calories:40,protein:10,carbs:0,fat:0,fiber:0,names:{en:`BCAA`,"pt-BR":`BCAA`}},{foodCode:`MALTODEXTRIN`,category:`supplements`,servingSize:1,servingUnit:`scoop`,calories:114,protein:0,carbs:28,fat:0,fiber:0,names:{en:`Maltodextrin`,"pt-BR":`Maltodextrina`}},{foodCode:`ALBUMIN`,category:`supplements`,servingSize:1,servingUnit:`scoop`,calories:108,protein:25,carbs:1,fat:0,fiber:0,names:{en:`Albumin`,"pt-BR":`Albumina`}},{foodCode:`GLUTAMINE`,category:`supplements`,servingSize:1,servingUnit:`scoop`,calories:20,protein:5,carbs:0,fat:0,fiber:0,names:{en:`Glutamine`,"pt-BR":`Glutamina`}},{foodCode:`PRE_WORKOUT`,category:`supplements`,servingSize:1,servingUnit:`scoop`,calories:15,protein:0,carbs:3,fat:0,fiber:0,names:{en:`Pre-Workout`,"pt-BR":`Pré-Treino`}},{foodCode:`COFFEE`,category:`beverages`,servingSize:200,servingUnit:`cup`,calories:2,protein:.3,carbs:0,fat:0,fiber:0,names:{en:`Coffee`,"pt-BR":`Café`}},{foodCode:`TEA`,category:`beverages`,servingSize:200,servingUnit:`cup`,calories:1,protein:0,carbs:.3,fat:0,fiber:0,names:{en:`Tea`,"pt-BR":`Chá`}},{foodCode:`ORANGE_JUICE`,category:`beverages`,servingSize:200,servingUnit:`cup`,calories:90,protein:1.4,carbs:21,fat:.4,fiber:.4,names:{en:`Orange Juice`,"pt-BR":`Suco de Laranja`}},{foodCode:`COCONUT_WATER`,category:`beverages`,servingSize:200,servingUnit:`cup`,calories:38,protein:1.4,carbs:7.4,fat:.4,fiber:2.2,names:{en:`Coconut Water`,"pt-BR":`Água de Coco`}},{foodCode:`SODA`,category:`beverages`,servingSize:350,servingUnit:`mL`,calories:140,protein:0,carbs:37,fat:0,fiber:0,names:{en:`Soda`,"pt-BR":`Refrigerante`}},{foodCode:`BEER`,category:`beverages`,servingSize:350,servingUnit:`mL`,calories:150,protein:1.6,carbs:12,fat:0,fiber:0,names:{en:`Beer`,"pt-BR":`Cerveja`}},{foodCode:`WINE`,category:`beverages`,servingSize:150,servingUnit:`mL`,calories:125,protein:.1,carbs:4,fat:0,fiber:0,names:{en:`Wine`,"pt-BR":`Vinho`}},{foodCode:`ENERGY_DRINK`,category:`beverages`,servingSize:250,servingUnit:`mL`,calories:115,protein:0,carbs:28,fat:0,fiber:0,names:{en:`Energy Drink`,"pt-BR":`Energético`}},{foodCode:`CHOCOLATE_MILK`,category:`beverages`,servingSize:200,servingUnit:`cup`,calories:180,protein:7,carbs:26,fat:5,fiber:1,names:{en:`Chocolate Milk`,"pt-BR":`Achocolatado`}},{foodCode:`SPORTS_DRINK`,category:`beverages`,servingSize:500,servingUnit:`mL`,calories:130,protein:0,carbs:32,fat:0,fiber:0,names:{en:`Sports Drink`,"pt-BR":`Isotônico`}},{foodCode:`HOT_CHOCOLATE`,category:`beverages`,servingSize:200,servingUnit:`cup`,calories:190,protein:8,carbs:27,fat:6,fiber:1.5,names:{en:`Hot Chocolate`,"pt-BR":`Chocolate Quente`}},{foodCode:`SPARKLING_WATER`,category:`beverages`,servingSize:200,servingUnit:`cup`,calories:0,protein:0,carbs:0,fat:0,fiber:0,names:{en:`Sparkling Water`,"pt-BR":`Água com Gás`}},{foodCode:`CHOCOLATE_BAR`,category:`desserts`,servingSize:1,servingUnit:`unit`,calories:135,protein:1.8,carbs:15,fat:7.6,fiber:1,names:{en:`Chocolate Bar`,"pt-BR":`Barra de Chocolate`}},{foodCode:`ICE_CREAM`,category:`desserts`,servingSize:100,servingUnit:`g`,calories:207,protein:3.5,carbs:24,fat:11,fiber:.7,names:{en:`Ice Cream`,"pt-BR":`Sorvete`}},{foodCode:`COOKIE`,category:`snacks`,servingSize:30,servingUnit:`g`,calories:145,protein:1.8,carbs:20,fat:6.5,fiber:.7,names:{en:`Cookie`,"pt-BR":`Biscoito`}},{foodCode:`POPCORN`,category:`snacks`,servingSize:30,servingUnit:`g`,calories:116,protein:3,carbs:22,fat:1.4,fiber:4.3,names:{en:`Popcorn`,"pt-BR":`Pipoca`}},{foodCode:`POTATO_CHIPS`,category:`snacks`,servingSize:30,servingUnit:`g`,calories:160,protein:2,carbs:15,fat:10.5,fiber:1.4,names:{en:`Potato Chips`,"pt-BR":`Batata Frita (Chips)`}},{foodCode:`DARK_CHOCOLATE`,category:`desserts`,servingSize:25,servingUnit:`g`,calories:145,protein:1.7,carbs:11,fat:10.5,fiber:2.8,names:{en:`Dark Chocolate`,"pt-BR":`Chocolate Amargo`}},{foodCode:`CAKE`,category:`desserts`,servingSize:80,servingUnit:`slice`,calories:290,protein:4,carbs:40,fat:13,fiber:.8,names:{en:`Cake`,"pt-BR":`Bolo`}},{foodCode:`PUDDING`,category:`desserts`,servingSize:100,servingUnit:`g`,calories:150,protein:3,carbs:22,fat:5,fiber:0,names:{en:`Pudding`,"pt-BR":`Pudim`}},{foodCode:`GELATIN`,category:`desserts`,servingSize:100,servingUnit:`g`,calories:62,protein:1.5,carbs:14,fat:0,fiber:0,names:{en:`Gelatin`,"pt-BR":`Gelatina`}},{foodCode:`HONEY`,category:`desserts`,servingSize:15,servingUnit:`tablespoon`,calories:46,protein:0,carbs:12.4,fat:0,fiber:0,names:{en:`Honey`,"pt-BR":`Mel`}},{foodCode:`JAM`,category:`desserts`,servingSize:15,servingUnit:`tablespoon`,calories:40,protein:.1,carbs:10,fat:0,fiber:.2,names:{en:`Jam`,"pt-BR":`Geleia`}},{foodCode:`SUGAR`,category:`desserts`,servingSize:10,servingUnit:`tablespoon`,calories:39,protein:0,carbs:10,fat:0,fiber:0,names:{en:`Sugar`,"pt-BR":`Açúcar`}},{foodCode:`BRIGADEIRO`,category:`desserts`,servingSize:1,servingUnit:`unit`,calories:78,protein:1,carbs:12,fat:3,fiber:.3,names:{en:`Brigadeiro`,"pt-BR":`Brigadeiro`}},{foodCode:`ALFAJOR`,category:`desserts`,servingSize:1,servingUnit:`unit`,calories:180,protein:2,carbs:24,fat:8.5,fiber:.6,names:{en:`Alfajor`,"pt-BR":`Alfajor`}},{foodCode:`WAFER`,category:`snacks`,servingSize:25,servingUnit:`g`,calories:130,protein:1.3,carbs:16,fat:7,fiber:.5,names:{en:`Wafer`,"pt-BR":`Wafer`}},{foodCode:`CEREAL_BAR`,category:`snacks`,servingSize:1,servingUnit:`unit`,calories:96,protein:1.5,carbs:18,fat:2.2,fiber:1.2,names:{en:`Cereal Bar`,"pt-BR":`Barra de Cereal`}},{foodCode:`OLIVE_OIL`,category:`others`,servingSize:13,servingUnit:`tablespoon`,calories:119,protein:0,carbs:0,fat:13.5,fiber:0,names:{en:`Olive Oil`,"pt-BR":`Azeite de Oliva`}},{foodCode:`SOYBEAN_OIL`,category:`others`,servingSize:14,servingUnit:`tablespoon`,calories:124,protein:0,carbs:0,fat:14,fiber:0,names:{en:`Soybean Oil`,"pt-BR":`Óleo de Soja`}},{foodCode:`SALT`,category:`others`,servingSize:1,servingUnit:`g`,calories:0,protein:0,carbs:0,fat:0,fiber:0,names:{en:`Salt`,"pt-BR":`Sal`}},{foodCode:`VINEGAR`,category:`others`,servingSize:15,servingUnit:`tablespoon`,calories:3,protein:0,carbs:.1,fat:0,fiber:0,names:{en:`Vinegar`,"pt-BR":`Vinagre`}},{foodCode:`MAYONNAISE`,category:`others`,servingSize:14,servingUnit:`tablespoon`,calories:94,protein:.1,carbs:.1,fat:10.3,fiber:0,names:{en:`Mayonnaise`,"pt-BR":`Maionese`}},{foodCode:`KETCHUP`,category:`others`,servingSize:17,servingUnit:`tablespoon`,calories:19,protein:.2,carbs:4.5,fat:0,fiber:.1,names:{en:`Ketchup`,"pt-BR":`Ketchup`}},{foodCode:`BLACK_PEPPER`,category:`others`,servingSize:1,servingUnit:`g`,calories:3,protein:.1,carbs:.6,fat:0,fiber:.3,names:{en:`Black Pepper`,"pt-BR":`Pimenta do Reino`}},{foodCode:`OREGANO`,category:`others`,servingSize:1,servingUnit:`g`,calories:3,protein:.1,carbs:.7,fat:.1,fiber:.4,names:{en:`Oregano`,"pt-BR":`Orégano`}},{foodCode:`CINNAMON`,category:`others`,servingSize:2,servingUnit:`g`,calories:5,protein:.1,carbs:1.7,fat:0,fiber:1.1,names:{en:`Cinnamon`,"pt-BR":`Canela`}},{foodCode:`BROWN_SUGAR`,category:`others`,servingSize:10,servingUnit:`tablespoon`,calories:38,protein:0,carbs:9.8,fat:0,fiber:0,names:{en:`Brown Sugar`,"pt-BR":`Açúcar Mascavo`}},{foodCode:`FAROFA`,category:`others`,servingSize:30,servingUnit:`g`,calories:110,protein:.8,carbs:22,fat:2,fiber:1.5,names:{en:`Toasted Cassava Flour (Farofa)`,"pt-BR":`Farofa`}},{foodCode:`PAO_DE_QUEIJO`,category:`bread`,servingSize:1,servingUnit:`unit`,calories:90,protein:2,carbs:9,fat:5,fiber:.2,names:{en:`Cheese Bread (Pão de Queijo)`,"pt-BR":`Pão de Queijo`}},{foodCode:`FRALDINHA`,category:`meat`,servingSize:100,servingUnit:`g`,calories:195,protein:27,carbs:0,fat:9,fiber:0,names:{en:`Flank Steak (Fraldinha)`,"pt-BR":`Fraldinha`}},{foodCode:`CUPIM`,category:`meat`,servingSize:100,servingUnit:`g`,calories:250,protein:24,carbs:0,fat:17,fiber:0,names:{en:`Beef Hump (Cupim)`,"pt-BR":`Cupim`}},{foodCode:`ACEM`,category:`meat`,servingSize:100,servingUnit:`g`,calories:215,protein:26,carbs:0,fat:12,fiber:0,names:{en:`Chuck (Acém)`,"pt-BR":`Acém`}},{foodCode:`COXAO_MOLE`,category:`meat`,servingSize:100,servingUnit:`g`,calories:175,protein:28,carbs:0,fat:6.5,fiber:0,names:{en:`Top Round (Coxão Mole)`,"pt-BR":`Coxão Mole`}},{foodCode:`COXAO_DURO`,category:`meat`,servingSize:100,servingUnit:`g`,calories:170,protein:28,carbs:0,fat:6,fiber:0,names:{en:`Bottom Round (Coxão Duro)`,"pt-BR":`Coxão Duro`}},{foodCode:`CONTRA_FILE`,category:`meat`,servingSize:100,servingUnit:`g`,calories:220,protein:27,carbs:0,fat:12,fiber:0,names:{en:`Striploin (Contra-Filé)`,"pt-BR":`Contra-Filé`}},{foodCode:`LINGUICA`,category:`meat`,servingSize:50,servingUnit:`g`,calories:150,protein:8,carbs:1,fat:13,fiber:0,names:{en:`Brazilian Sausage (Linguiça)`,"pt-BR":`Linguiça`}},{foodCode:`CALABRESA`,category:`meat`,servingSize:50,servingUnit:`g`,calories:155,protein:7.5,carbs:1,fat:13.5,fiber:0,names:{en:`Calabrese Sausage`,"pt-BR":`Calabresa`}},{foodCode:`MORTADELA`,category:`meat`,servingSize:30,servingUnit:`g`,calories:88,protein:3.8,carbs:1,fat:7.5,fiber:0,names:{en:`Mortadella`,"pt-BR":`Mortadela`}},{foodCode:`PICANHA`,category:`meat`,servingSize:100,servingUnit:`g`,calories:230,protein:26,carbs:0,fat:14,fiber:0,names:{en:`Top Sirloin Cap (Picanha)`,"pt-BR":`Picanha`}},{foodCode:`MAMINHA`,category:`meat`,servingSize:100,servingUnit:`g`,calories:180,protein:27,carbs:0,fat:7.5,fiber:0,names:{en:`Tri-Tip (Maminha)`,"pt-BR":`Maminha`}},{foodCode:`REQUEIJAO_LIGHT`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:45,protein:2.8,carbs:1.5,fat:3,fiber:0,names:{en:`Light Requeijão`,"pt-BR":`Requeijão Light`}},{foodCode:`CREAM_CHEESE_LIGHT`,category:`dairy`,servingSize:30,servingUnit:`g`,calories:60,protein:2.8,carbs:2,fat:4.5,fiber:0,names:{en:`Light Cream Cheese`,"pt-BR":`Cream Cheese Light`}},{foodCode:`AGRIAO`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:11,protein:2.3,carbs:1.3,fat:.1,fiber:.5,names:{en:`Watercress`,"pt-BR":`Agrião`}},{foodCode:`COUVE_MANTEIGA`,category:`vegetables`,servingSize:100,servingUnit:`g`,calories:27,protein:2,carbs:4.3,fat:.5,fiber:2,names:{en:`Collard Greens`,"pt-BR":`Couve-Manteiga`}},{foodCode:`FEIJOADA`,category:`others`,servingSize:200,servingUnit:`g`,calories:280,protein:18,carbs:22,fat:14,fiber:6,names:{en:`Feijoada`,"pt-BR":`Feijoada`}},{foodCode:`PAO_DE_FORMA`,category:`bread`,servingSize:25,servingUnit:`slice`,calories:65,protein:2,carbs:12,fat:.8,fiber:.6,names:{en:`Sandwich Bread`,"pt-BR":`Pão de Forma`}},{foodCode:`FARINHA_DE_MANDIOCA`,category:`grains`,servingSize:30,servingUnit:`g`,calories:105,protein:.3,carbs:26,fat:.1,fiber:1.3,names:{en:`Cassava Flour`,"pt-BR":`Farinha de Mandioca`}},{foodCode:`ACAI`,category:`fruits`,servingSize:100,servingUnit:`g`,calories:58,protein:.8,carbs:6,fat:3.9,fiber:2.6,names:{en:`Açaí`,"pt-BR":`Açaí`}},{foodCode:`GUARANA`,category:`beverages`,servingSize:350,servingUnit:`mL`,calories:140,protein:0,carbs:37,fat:0,fiber:0,names:{en:`Guaraná Soda`,"pt-BR":`Guaraná`}},{foodCode:`COXINHA`,category:`snacks`,servingSize:70,servingUnit:`unit`,calories:190,protein:7,carbs:18,fat:10,fiber:.8,names:{en:`Coxinha`,"pt-BR":`Coxinha`}},{foodCode:`PASTEL`,category:`snacks`,servingSize:60,servingUnit:`unit`,calories:220,protein:5,carbs:20,fat:13,fiber:.9,names:{en:`Pastel`,"pt-BR":`Pastel`}},{foodCode:`BEIJINHO`,category:`desserts`,servingSize:20,servingUnit:`unit`,calories:75,protein:.8,carbs:11,fat:3,fiber:.3,names:{en:`Beijinho`,"pt-BR":`Beijinho`}},{foodCode:`VINAGRETE`,category:`others`,servingSize:50,servingUnit:`g`,calories:20,protein:.4,carbs:4,fat:.3,fiber:1,names:{en:`Brazilian Vinaigrette (Vinagrete)`,"pt-BR":`Vinagrete`}},{foodCode:`PAO_DE_ALHO`,category:`bread`,servingSize:40,servingUnit:`unit`,calories:140,protein:3,carbs:16,fat:7,fiber:.8,names:{en:`Garlic Bread`,"pt-BR":`Pão de Alho`}}];function F(e,t){let n=Ft.find(t=>t.foodCode===e);return n?n.names[t]??n.names.en:null}var It=[`fruits`,`vegetables`,`legumes`,`grains`,`roots`,`nuts`,`meat`,`chicken`,`fish`,`eggs`,`dairy`,`bread`,`beverages`,`supplements`,`desserts`,`snacks`,`others`],Lt=[`g`,`mL`,`unit`,`slice`,`scoop`,`cup`,`tablespoon`,`serving`];function Rt(e={},t){let n=T();return{id:t?.id??e.id??P(`food`),foodCode:e.foodCode??t?.foodCode??null,isBuiltIn:t?.isBuiltIn??!!e.isBuiltIn,name:String(e.name??t?.name??``).trim(),category:Bt(e.category??t?.category,It,`others`),servingSize:Vt(e.servingSize??t?.servingSize,100),servingUnit:Bt(e.servingUnit??t?.servingUnit,Lt,`g`),calories:I(e.calories??t?.calories),protein:I(e.protein??t?.protein),carbs:I(e.carbs??t?.carbs),fat:I(e.fat??t?.fat),fiber:I(e.fiber??t?.fiber),favorite:t?.favorite??!1,createdAt:t?.createdAt??n,updatedAt:n}}function zt(e){let t={};return e.name||(t.name=`validation.foodNameRequired`),(!e.servingSize||e.servingSize<=0)&&(t.servingSize=`validation.servingSizePositive`),t}function Bt(e,t,n){return t.includes(e)?e:n}function Vt(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}function I(e){let t=Number(e);return Number.isFinite(t)&&t>=0?t:0}function Ht(e,t){return Rt({foodCode:e.foodCode,isBuiltIn:!0,category:e.category,servingSize:e.servingSize,servingUnit:e.servingUnit,calories:e.calories,protein:e.protein,carbs:e.carbs,fat:e.fat,fiber:e.fiber,name:t?.name??e.names.en},t)}async function Ut(e){await e.hasSeededStarterCatalog()||((await e.list()).length===0&&await e.saveMany(Ft.map(e=>Ht(e))),await e.markStarterCatalogSeeded(2))}async function Wt(e){let t=await e.list(),n=new Map(t.filter(e=>e.foodCode).map(e=>[e.foodCode,e])),r=Ft.map(e=>Ht(e,n.get(e.foodCode)));await e.saveMany(r),await e.markStarterCatalogSeeded(2)}var Gt=`developer-mode:enabled`,Kt=7,qt=class{constructor({repositoryFactory:e,foodLibraryRepository:t,eventBus:n}){this.metadataRepository=e.getRepository(c.metadata),this.foodLibraryRepository=t,this.eventBus=n,this.isEnabled=!1,this.justEnabled=!1,this.tapCount=0,this.confirmingAction=null,this.message=``,this.storedCatalogVersion=null}async initialize(){let e=await this.metadataRepository.getById(Gt);this.isEnabled=!!e?.value,this.storedCatalogVersion=await this.foodLibraryRepository.getStoredCatalogVersion()}getState(){return{isEnabled:this.isEnabled,justEnabled:this.justEnabled,confirmingAction:this.confirmingAction,message:this.message,versions:{app:`3.0`,database:6,catalogCurrent:2,catalogStored:this.storedCatalogVersion}}}async handleAction(e,t={}){if(e===`tapLogo`){await this.#e();return}if(e===`requestConfirm`){this.confirmingAction=t.tool??null,this.message=``;return}if(e===`cancelConfirm`){this.confirmingAction=null;return}if(e===`clearDatabase`){await this.#t();return}if(e===`resetFirstLaunch`){await this.#n();return}e===`reimportCatalog`&&await this.#r()}async#e(){this.justEnabled=!1,!this.isEnabled&&(this.tapCount+=1,this.tapCount>=Kt&&(this.tapCount=0,this.isEnabled=!0,this.justEnabled=!0,await this.metadataRepository.save({key:Gt,value:!0,updatedAt:new Date().toISOString()})))}async#t(){this.confirmingAction=null,await Jt(),window.location.reload()}async#n(){if(this.confirmingAction=null,`serviceWorker`in navigator){let e=await navigator.serviceWorker.getRegistrations();await Promise.all(e.map(e=>e.unregister()))}if(`caches`in window){let e=await caches.keys();await Promise.all(e.map(e=>caches.delete(e)))}await Jt(),window.location.reload()}async#r(){this.confirmingAction=null,await Wt(this.foodLibraryRepository),this.storedCatalogVersion=await this.foodLibraryRepository.getStoredCatalogVersion(),this.message=`developer.catalogReimportedMessage`,this.eventBus.publish(`food-library:changed`),this.eventBus.publish(`core-mvp:data-changed`)}};function Jt(){return new Promise((e,t)=>{let n=indexedDB.deleteDatabase(s);n.onsuccess=()=>e(),n.onerror=()=>t(n.error),n.onblocked=()=>e()})}var Yt=`favorites:sort-option`,Xt=class{constructor({repositoryFactory:e}){this.repository=e.getRepository(u.favoriteMeals),this.metadataRepository=e.getRepository(c.metadata)}async list(){return ve(await this.repository.getAll(),`name`)}async getById(e){return this.repository.getById(e)}async save(e){return this.repository.save(e)}async delete(e){return this.repository.delete(e)}async getSortOption(){return(await this.metadataRepository.getById(Yt))?.value??`mostUsed`}async saveSortOption(e){await this.metadataRepository.save({key:Yt,value:e,updatedAt:new Date().toISOString()})}},Zt=[...Le,`custom`],Qt={snack:`morningSnack`,meal:`custom`};function $t(e){return e===`custom`?`meal`:e}function en(e){return Le.includes(e)?e:Qt[e]??`custom`}function tn(e={}){return{foodCode:e.foodCode,quantity:sn(e.quantity),servingUnit:e.servingUnit}}function nn(e={},t){let n=T();return{id:t?.id??e.id??P(`favorite-meal`),name:String(e.name??t?.name??``).trim(),category:on(e.category??t?.category,Zt,`custom`),items:Array.isArray(e.items)?e.items.map(tn):t?.items??[],usageCount:cn(e.usageCount??t?.usageCount),lastUsedAt:e.lastUsedAt??t?.lastUsedAt??null,createdAt:t?.createdAt??n,updatedAt:n}}function rn(e){let t=T();return{...e,usageCount:(e.usageCount??0)+1,lastUsedAt:t,updatedAt:t}}function an(e){let t={};return e.name||(t.name=`validation.favoriteMealNameRequired`),(!e.items||e.items.length===0)&&(t.items=`validation.favoriteMealItemsRequired`),t}function on(e,t,n){return t.includes(e)?e:n}function sn(e){let t=Number(e);return Number.isFinite(t)&&t>0?t:0}function cn(e){let t=Number(e);return Number.isFinite(t)&&t>=0?Math.trunc(t):0}function L(e={},t){let n=T();return{id:t?.id??e.id??P(`meal`),mealDate:e.mealDate||t?.mealDate||w(),mealType:e.mealType||t?.mealType||`meal`,title:String(e.title??t?.title??``).trim(),notes:String(e.notes??t?.notes??``).trim(),source:e.source||t?.source||`manual`,calories:C(e.calories??t?.calories),protein:C(e.protein??t?.protein),carbs:C(e.carbs??t?.carbs),fat:C(e.fat??t?.fat),fiber:C(e.fiber??t?.fiber),hwpFoodRaw:e.hwpFoodRaw??t?.hwpFoodRaw??null,createdAt:t?.createdAt??n,updatedAt:n}}function ln(e){let t={};return e.mealDate||(t.mealDate=`validation.dateRequired`),e.title||(t.title=`validation.mealNameRequired`),t}var un=Object.freeze({calories:0,protein:0,carbs:0,fat:0,fiber:0});function dn(e){return e.foodCode??e.id}function fn(e,t){return e.find(e=>dn(e)===t.foodCode)??null}function pn(e,t){if(!e)return{...un};let n=e.servingSize>0?t.quantity/e.servingSize:0;return{calories:e.calories*n,protein:e.protein*n,carbs:e.carbs*n,fat:e.fat*n,fiber:e.fiber*n}}function R(e,t){return(e.items??[]).reduce((e,n)=>{let r=pn(fn(t,n),n);return{calories:e.calories+r.calories,protein:e.protein+r.protein,carbs:e.carbs+r.carbs,fat:e.fat+r.fat,fiber:e.fiber+r.fiber}},{...un})}async function mn({favoriteMeal:e,mealSlot:t,foods:n,favoriteMealsRepository:r,mealJournalRepository:i}){let a=R(e,n),o=L({mealType:t,title:e.name,source:`favorite`,calories:a.calories,protein:a.protein,carbs:a.carbs,fat:a.fat,fiber:a.fiber});return await i.save(o),await r.save(rn(e)),o}var hn=[`mostUsed`,`recentlyUsed`,`alphabetical`];function gn(e,t){let n=[...e];return t===`recentlyUsed`?n.sort((e,t)=>String(t.lastUsedAt??``).localeCompare(String(e.lastUsedAt??``))):t===`alphabetical`?n.sort((e,t)=>e.name.localeCompare(t.name)):n.sort((e,t)=>(t.usageCount??0)-(e.usageCount??0))}var _n=class{constructor({repository:e,foodLibraryRepository:t,mealJournalRepository:n,eventBus:r}){this.repository=e,this.foodLibraryRepository=t,this.mealJournalRepository=n,this.eventBus=r,this.favoriteMeals=[],this.foods=[],this.sortOption=`mostUsed`,this.activeDialog=null,this.wizardMode=`create`,this.wizardStep=`details`,this.draft=null,this.pickingFoodId=null,this.editingItemIndex=null,this.selectedFavoriteId=null,this.errors={},this.message=``}async initialize(){this.sortOption=await this.repository.getSortOption(),await this.load()}async load(){this.favoriteMeals=await this.repository.list(),this.foods=await this.foodLibraryRepository.list()}getState(){return{favoriteMeals:gn(this.favoriteMeals,this.sortOption),sortOption:this.sortOption,foods:this.foods,activeDialog:this.activeDialog,wizardMode:this.wizardMode,wizardStep:this.wizardStep,draft:this.draft,pickingFood:this.pickingFoodId?this.foods.find(e=>e.id===this.pickingFoodId)??null:null,editingItemIndex:this.editingItemIndex,selectedFavoriteId:this.selectedFavoriteId,errors:this.errors,message:this.message,totals:this.draft?R(this.draft,this.foods):null}}async handleAction(e,t={}){if(e===`openCreate`){this.#t(`create`,null);return}if(e===`openEdit`){this.#t(`edit`,t.id);return}if(e===`closeDialog`||e===`closeWizard`){this.#n();return}if(e===`wizardBack`){this.#r();return}if(e===`saveDetails`){this.#i(t);return}if(e===`openFoodPicker`){this.pickingFoodId=t.id,this.editingItemIndex=t.index===void 0?null:Number(t.index);return}if(e===`cancelFoodPicker`){this.pickingFoodId=null,this.editingItemIndex=null;return}if(e===`addItem`){this.#a(t);return}if(e===`removeItem`){this.#o(t);return}if(e===`goToPreview`){(this.draft?.items?.length??0)>0&&(this.wizardStep=`preview`);return}if(e===`backToItems`){this.wizardStep=`items`;return}if(e===`saveFavorite`){await this.#c();return}if(e===`openDeleteConfirm`){this.selectedFavoriteId=t.id,this.activeDialog=`delete-confirm`;return}if(e===`confirmDelete`){await this.#l(t.id??this.selectedFavoriteId);return}if(e===`register`){await this.#u(t.id);return}if(e===`startFromImportedMeal`){await this.#d(t);return}if(e===`saveQuickFavorite`){await this.#s(t);return}e===`setSortOption`&&await this.#e(t.sortOption)}async#e(e){hn.includes(e)&&(this.sortOption=e,await this.repository.saveSortOption(e))}#t(e,t){if(e===`edit`){let e=this.favoriteMeals.find(e=>e.id===t);if(!e)return;this.draft={id:e.id,name:e.name,category:e.category,items:e.items.map(e=>({...e}))}}else this.draft={id:null,name:``,category:`custom`,items:[]};this.wizardMode=e,this.wizardStep=`details`,this.pickingFoodId=null,this.editingItemIndex=null,this.activeDialog=`wizard`,this.errors={},this.message=``}#n(){this.activeDialog=null,this.draft=null,this.pickingFoodId=null,this.editingItemIndex=null,this.selectedFavoriteId=null,this.errors={}}#r(){if(this.wizardStep===`items`){this.wizardStep=`details`;return}if(this.wizardStep===`preview`){this.wizardStep=`items`;return}this.#n()}#i(e){let t=String(e.name??``).trim();if(!t){this.errors={name:`validation.favoriteMealNameRequired`};return}this.draft={...this.draft,name:t,category:e.category??this.draft.category},this.errors={},this.wizardStep=`items`}#a(e){let t=this.foods.find(t=>t.id===e.foodId);if(!t||!this.draft)return;let n=Number(e.quantity)||0;if(n<=0)return;let r={foodCode:dn(t),quantity:n,servingUnit:t.servingUnit},i=[...this.draft.items];this.editingItemIndex!==null&&i[this.editingItemIndex]?i[this.editingItemIndex]=r:i.push(r),this.draft={...this.draft,items:i},this.pickingFoodId=null,this.editingItemIndex=null}#o(e){if(!this.draft)return;let t=Number(e.index),n=this.draft.items.filter((e,n)=>n!==t);this.draft={...this.draft,items:n}}async#s(e){let t=String(e.name??``).trim();if(!t){this.errors={name:`validation.favoriteMealNameRequired`};return}this.draft={...this.draft,name:t,category:e.category??this.draft.category},this.errors={},await this.#c()}async#c(){let e=nn({...this.draft,id:this.draft?.id??null},null),t=an(e);if(Object.keys(t).length>0){this.errors=t;return}await this.repository.save(e),await this.load(),this.#n(),this.message=`message.recordSaved`,this.#f()}async#l(e){e&&(await this.repository.delete(e),await this.load(),this.#n(),this.message=`message.recordDeleted`,this.#f())}async#u(e){let t=this.favoriteMeals.find(t=>t.id===e);t&&(await mn({favoriteMeal:t,mealSlot:$t(t.category),foods:this.foods,favoriteMealsRepository:this.repository,mealJournalRepository:this.mealJournalRepository}),await this.load(),this.message=`message.favoriteRegistered`,this.eventBus.publish(`meal-journal:changed`),this.eventBus.publish(`core-mvp:data-changed`))}async#d(e){let t=Rt({name:e.name,category:`others`,servingSize:100,servingUnit:`serving`,calories:Number(e.calories)||0,protein:Number(e.protein)||0,carbs:Number(e.carbs)||0,fat:Number(e.fat)||0,fiber:Number(e.fiber)||0});await this.foodLibraryRepository.save(t),await this.load(),this.eventBus.publish(`food-library:changed`),this.eventBus.publish(`core-mvp:data-changed`),this.draft={id:null,name:e.name??``,category:en(e.mealType),items:[{foodCode:dn(t),quantity:t.servingSize,servingUnit:t.servingUnit}]},this.wizardMode=`create`,this.wizardStep=`details`,this.activeDialog=`quick-save`,this.pickingFoodId=null,this.editingItemIndex=null,this.errors={},this.message=``}#f(){this.eventBus.publish(`favorites:changed`),this.eventBus.publish(`core-mvp:data-changed`)}},vn=`food-library:starter-catalog-seeded`,yn=`food-library:starter-catalog-version`,bn=class{constructor({repositoryFactory:e}){this.repository=e.getRepository(u.foods),this.metadataRepository=e.getRepository(c.metadata)}async list(){return ve(await this.repository.getAll(),`name`)}async getById(e){return this.repository.getById(e)}async save(e){return this.repository.save(e)}async saveMany(e){return this.repository.saveMany(e)}async delete(e){return this.repository.delete(e)}async hasSeededStarterCatalog(){return!!(await this.metadataRepository.getById(vn))?.value}async getStoredCatalogVersion(){return(await this.metadataRepository.getById(yn))?.value??null}async markStarterCatalogSeeded(e){let t=new Date().toISOString();await this.metadataRepository.save({key:vn,value:!0,updatedAt:t}),await this.metadataRepository.save({key:yn,value:e,updatedAt:t})}},xn=class{constructor({repository:e,mealJournalRepository:t,eventBus:n}){this.repository=e,this.mealJournalRepository=t,this.eventBus=n,this.foods=[],this.activeDialog=null,this.editingFoodId=null,this.selectedFoodId=null,this.errors={},this.message=``}async initialize(){await Ut(this.repository),await this.load()}async reimportStarterCatalog(){await Wt(this.repository),await this.load(),this.#a()}async load(){this.foods=await this.repository.list()}getState(){return{foods:this.foods,activeDialog:this.activeDialog,editingFood:this.editingFoodId?this.foods.find(e=>e.id===this.editingFoodId)??null:null,selectedFood:this.selectedFoodId?this.foods.find(e=>e.id===this.selectedFoodId)??null:null,errors:this.errors,message:this.message}}async handleAction(e,t={}){if(e===`openAdd`){this.#e(null);return}if(e===`openEdit`){this.#e(t.id);return}if(e===`closeDialog`){this.#t();return}if(e===`save`){await this.#n(t);return}if(e===`openDeleteConfirm`){this.selectedFoodId=t.id,this.activeDialog=`delete-confirm`;return}if(e===`confirmDelete`){await this.#r(t.id??this.selectedFoodId);return}if(e===`openQuantity`){this.selectedFoodId=t.id,this.activeDialog=`quantity`;return}e===`addToMeal`&&await this.#i(t)}#e(e){this.editingFoodId=e,this.activeDialog=`form`,this.errors={},this.message=``}#t(){this.activeDialog=null,this.editingFoodId=null,this.selectedFoodId=null,this.errors={}}async#n(e){let t=this.editingFoodId?await this.repository.getById(this.editingFoodId):null,n=Rt({...e,id:this.editingFoodId},t),r=zt(n);if(Object.keys(r).length>0){this.errors=r;return}await this.repository.save(n),await this.load(),this.#t(),this.message=`message.recordSaved`,this.#a()}async#r(e){e&&(await this.repository.delete(e),await this.load(),this.#t(),this.message=`message.recordDeleted`,this.#a())}async#i(e){let t=await this.repository.getById(e.foodId);if(!t)return;let n=Number(e.quantity)||0,r=t.servingSize>0?n/t.servingSize:0,i=L({title:t.name,mealType:`meal`,source:`library`,calories:t.calories*r,protein:t.protein*r,carbs:t.carbs*r,fat:t.fat*r,fiber:t.fiber*r});await this.mealJournalRepository.save(i),this.#t(),this.message=`message.foodAddedToMeal`,this.eventBus.publish(`meal-journal:changed`),this.eventBus.publish(`core-mvp:data-changed`)}#a(){this.eventBus.publish(`food-library:changed`),this.eventBus.publish(`core-mvp:data-changed`)}},Sn=class{constructor({repositoryFactory:e}){this.repository=e.getRepository(u.meals)}async list(){return _e(await this.repository.getAll(),`mealDate`)}async getById(e){return this.repository.getById(e)}async save(e){return this.repository.save(e)}async delete(e){return this.repository.delete(e)}},Cn=class extends wt{constructor({repository:e,eventBus:t}){super({repository:e,eventBus:t,entityName:`meal-journal`,createEntity:L,validateEntity:ln})}async handleAction(e,t={}){if(e===`importHwpFood`){await this.#e(t);return}await super.handleAction(e,t)}async#e(e){let t=L({mealType:e.mealType,title:e.name,calories:e.calories,protein:e.protein,carbs:e.carbs,fat:e.fat,fiber:e.fiber,source:`hwp_food`,hwpFoodRaw:e.raw});await this.repository.save(t),await this.load(),this.message=`message.mealImported`,this.publishChange()}},wn=class{constructor({repositoryFactory:e}){this.repository=e.getRepository(u.mealPlans)}async list(){return ve(await this.repository.getAll(),`name`)}async getById(e){return this.repository.getById(e)}async save(e){return this.repository.save(e)}async delete(e){return this.repository.delete(e)}};function Tn(e={}){return{favoriteMealId:e.favoriteMealId,mealSlot:e.mealSlot}}function En(e={},t){let n=T();return{id:t?.id??e.id??P(`meal-plan`),name:String(e.name??t?.name??``).trim(),description:String(e.description??t?.description??``).trim(),meals:Array.isArray(e.meals)?e.meals.map(Tn):t?.meals??[],createdAt:t?.createdAt??n,updatedAt:n}}function Dn(e){let t={};return e.name||(t.name=`validation.mealPlanNameRequired`),(!e.meals||e.meals.length===0)&&(t.meals=`validation.mealPlanMealsRequired`),t}var On=Object.freeze({calories:0,protein:0,carbs:0,fat:0,fiber:0});function kn(e,t){return e.find(e=>e.id===t.favoriteMealId)??null}function An(e,t,n){return(e.meals??[]).reduce((e,r)=>{let i=kn(t,r),a=i?R(i,n):On;return{calories:e.calories+a.calories,protein:e.protein+a.protein,carbs:e.carbs+a.carbs,fat:e.fat+a.fat,fiber:e.fiber+a.fiber}},{...On})}var jn=class{constructor({repository:e,favoriteMealsRepository:t,foodLibraryRepository:n,mealJournalRepository:r,eventBus:i}){this.repository=e,this.favoriteMealsRepository=t,this.foodLibraryRepository=n,this.mealJournalRepository=r,this.eventBus=i,this.mealPlans=[],this.favoriteMeals=[],this.foods=[],this.activeDialog=null,this.wizardMode=`create`,this.wizardStep=`details`,this.draft=null,this.pickingFavoriteMealId=null,this.editingMealIndex=null,this.selectedPlanId=null,this.errors={},this.message=``}async initialize(){await this.load()}async load(){this.mealPlans=await this.repository.list(),this.favoriteMeals=await this.favoriteMealsRepository.list(),this.foods=await this.foodLibraryRepository.list()}getState(){return{mealPlans:this.mealPlans,favoriteMeals:this.favoriteMeals,foods:this.foods,activeDialog:this.activeDialog,wizardMode:this.wizardMode,wizardStep:this.wizardStep,draft:this.draft,pickingFavoriteMeal:this.pickingFavoriteMealId?this.favoriteMeals.find(e=>e.id===this.pickingFavoriteMealId)??null:null,editingMealIndex:this.editingMealIndex,selectedPlanId:this.selectedPlanId,errors:this.errors,message:this.message,totals:this.draft?An(this.draft,this.favoriteMeals,this.foods):null}}async handleAction(e,t={}){if(e===`openCreate`){this.#e(`create`,null);return}if(e===`openEdit`){this.#e(`edit`,t.id);return}if(e===`closeDialog`||e===`closeWizard`){this.#t();return}if(e===`wizardBack`){this.#n();return}if(e===`saveDetails`){this.#r(t);return}if(e===`openFavoritePicker`){this.pickingFavoriteMealId=t.id,this.editingMealIndex=t.index===void 0?null:Number(t.index);return}if(e===`cancelFavoritePicker`){this.pickingFavoriteMealId=null,this.editingMealIndex=null;return}if(e===`addMeal`){this.#i(t);return}if(e===`removeMeal`){this.#a(t);return}if(e===`goToPreview`){(this.draft?.meals?.length??0)>0&&(this.wizardStep=`preview`);return}if(e===`backToMeals`){this.wizardStep=`meals`;return}if(e===`saveMealPlan`){await this.#o();return}if(e===`openDeleteConfirm`){this.selectedPlanId=t.id,this.activeDialog=`delete-confirm`;return}if(e===`confirmDelete`){await this.#s(t.id??this.selectedPlanId);return}e===`register`&&await this.#c(t.id)}#e(e,t){if(e===`edit`){let e=this.mealPlans.find(e=>e.id===t);if(!e)return;this.draft={id:e.id,name:e.name,description:e.description,meals:e.meals.map(e=>({...e}))}}else this.draft={id:null,name:``,description:``,meals:[]};this.wizardMode=e,this.wizardStep=`details`,this.pickingFavoriteMealId=null,this.editingMealIndex=null,this.activeDialog=`wizard`,this.errors={},this.message=``}#t(){this.activeDialog=null,this.draft=null,this.pickingFavoriteMealId=null,this.editingMealIndex=null,this.selectedPlanId=null,this.errors={}}#n(){if(this.wizardStep===`meals`){this.wizardStep=`details`;return}if(this.wizardStep===`preview`){this.wizardStep=`meals`;return}this.#t()}#r(e){let t=String(e.name??``).trim();if(!t){this.errors={name:`validation.mealPlanNameRequired`};return}this.draft={...this.draft,name:t,description:String(e.description??``).trim()},this.errors={},this.wizardStep=`meals`}#i(e){let t=this.favoriteMeals.find(t=>t.id===e.favoriteMealId);if(!t||!this.draft||!e.mealSlot)return;let n={favoriteMealId:t.id,mealSlot:e.mealSlot},r=[...this.draft.meals];this.editingMealIndex!==null&&r[this.editingMealIndex]?r[this.editingMealIndex]=n:r.push(n),this.draft={...this.draft,meals:r},this.pickingFavoriteMealId=null,this.editingMealIndex=null}#a(e){if(!this.draft)return;let t=Number(e.index),n=this.draft.meals.filter((e,n)=>n!==t);this.draft={...this.draft,meals:n}}async#o(){let e=En({...this.draft,id:this.draft?.id??null},null),t=Dn(e);if(Object.keys(t).length>0){this.errors=t;return}await this.repository.save(e),await this.load(),this.#t(),this.message=`message.recordSaved`,this.#l()}async#s(e){e&&(await this.repository.delete(e),await this.load(),this.#t(),this.message=`message.recordDeleted`,this.#l())}async#c(e){let t=this.mealPlans.find(t=>t.id===e);if(!(!t||t.meals.length===0)){for(let e of t.meals){let t=kn(this.favoriteMeals,e);t&&await mn({favoriteMeal:t,mealSlot:e.mealSlot,foods:this.foods,favoriteMealsRepository:this.favoriteMealsRepository,mealJournalRepository:this.mealJournalRepository})}await this.load(),this.message=`message.mealPlanRegistered`,this.eventBus.publish(`meal-journal:changed`),this.eventBus.publish(`core-mvp:data-changed`)}}#l(){this.eventBus.publish(`meal-plans:changed`),this.eventBus.publish(`core-mvp:data-changed`)}},Mn=class{constructor({repositoryFactory:e}){this.repository=e.getRepository(u.medicationApplications)}async list(){return _e(await this.repository.getAll(),`administeredAt`)}async getById(e){return this.repository.getById(e)}async save(e){return this.repository.save(e)}async delete(e){return this.repository.delete(e)}};function Nn(e={},t){let n=T();return{id:t?.id??e.id??P(`medication`),administeredAt:e.administeredAt||t?.administeredAt||w(),doseMg:C(e.doseMg??t?.doseMg),site:e.site||t?.site||`not-specified`,notes:String(e.notes??t?.notes??``).trim(),createdAt:t?.createdAt??n,updatedAt:n}}function Pn(e){let t={};return e.administeredAt||(t.administeredAt=`validation.dateRequired`),(e.doseMg===null||e.doseMg<=0)&&(t.doseMg=`validation.dosePositive`),t}var Fn=class extends wt{constructor({repository:e,eventBus:t}){super({repository:e,eventBus:t,entityName:`medication`,createEntity:Nn,validateEntity:Pn})}},In=[`injection`,`tablet`,`capsule`,`drops`,`cream`,`other`],Ln=[`daily`,`weekly`,`every-2-weeks`,`monthly`,`custom`],Rn=[`mg`,`mcg`,`mL`,`IU`,`units`,`other`],zn=[`monday`,`tuesday`,`wednesday`,`thursday`,`friday`,`saturday`,`sunday`],z=Object.freeze({enabled:!0,name:``,administrationType:`injection`,frequency:`weekly`,defaultDose:null,doseUnit:`mg`,applicationDay:`monday`,notes:``});function Bn(e={},t,n={}){let r=t?.medication??{};return{enabled:e.medicationEnabled===void 0?r.enabled??z.enabled:e.medicationEnabled===`on`,name:String(e.medicationName??r.name??z.name).trim(),administrationType:B(e.administrationType??r.administrationType??z.administrationType,In),frequency:B(e.frequency??r.frequency??z.frequency,Ln),defaultDose:C(e.defaultDose??r.defaultDose??n.tirzepatideDose),doseUnit:B(e.doseUnit??r.doseUnit??n.doseUnit??z.doseUnit,Rn),applicationDay:B(e.applicationDay??r.applicationDay??n.injectionDay??z.applicationDay,zn),notes:String(e.medicationNotes??r.notes??z.notes).trim()}}function B(e,t){return t.includes(e)?e:t[0]}var Vn=`app-settings`,Hn=Object.freeze({en:{weightUnit:`lb`,measurementUnit:`in`},"pt-BR":{weightUnit:`kg`,measurementUnit:`cm`}}),V=Object.freeze({id:Vn,displayName:``,language:`pt-BR`,theme:`system`,sex:``,birthDate:``,height:null,healthGoal:`lose-weight`,activityLevel:`moderate`,currentWeight:null,targetWeight:null,calorieGoal:2e3,proteinGoal:120,carbsGoal:180,fatGoal:65,fiberGoal:25,waterGoal:3e3,sleepGoal:8,stepGoal:8e3,medication:z,dashboardCards:{calories:!0,protein:!0,water:!0,sleep:!0,steps:!0,weight:!0,medication:!0,recentMeals:!0,recentActivity:!0},weightUnit:`lb`,measurementUnit:`in`,startScreen:`/`,mealSlots:Object.fromEntries(O.map(e=>[e,!1]))});function Un(e={},t){let n=T(),r=Wn(e.language??t?.language??V.language),i=Hn[r];return{...V,...t,displayName:String(e.displayName??t?.displayName??V.displayName).trim(),language:r,theme:Gn(e.theme??t?.theme??V.theme),sex:Jn(e.sex??t?.sex,[``,`female`,`male`,`other`]),birthDate:e.birthDate??t?.birthDate??V.birthDate,height:Yn(e.height??t?.height),healthGoal:Jn(e.healthGoal??t?.healthGoal,[`lose-weight`,`maintain-weight`,`gain-muscle`]),activityLevel:Jn(e.activityLevel??t?.activityLevel,[`sedentary`,`light`,`moderate`,`intense`]),currentWeight:Yn(e.currentWeight??t?.currentWeight),targetWeight:Yn(e.targetWeight??t?.targetWeight),calorieGoal:H(e.calorieGoal??t?.calorieGoal,V.calorieGoal),proteinGoal:H(e.proteinGoal??t?.proteinGoal,V.proteinGoal),carbsGoal:H(e.carbsGoal??t?.carbsGoal,V.carbsGoal),fatGoal:H(e.fatGoal??t?.fatGoal,V.fatGoal),fiberGoal:H(e.fiberGoal??t?.fiberGoal,V.fiberGoal),waterGoal:H(e.waterGoal??t?.waterGoal,V.waterGoal),sleepGoal:H(e.sleepGoal??t?.sleepGoal,V.sleepGoal),stepGoal:H(e.stepGoal??t?.stepGoal,V.stepGoal),medication:Bn(e,t,{tirzepatideDose:t?.tirzepatideDose,doseUnit:t?.doseUnit,injectionDay:t?.injectionDay}),dashboardCards:Kn(e,t),mealSlots:qn(e,t),weightUnit:i.weightUnit,measurementUnit:i.measurementUnit,startScreen:e.startScreen||t?.startScreen||V.startScreen,createdAt:t?.createdAt??n,updatedAt:n}}function Wn(e){return e===`pt-BR`?`pt-BR`:`en`}function Gn(e){return[`light`,`dark`,`system`].includes(e)?e:`system`}function Kn(e,t){let n=t?.dashboardCards??V.dashboardCards;return Object.fromEntries(Object.keys(V.dashboardCards).map(t=>[t,e[`dashboardCard_${t}`]===void 0?n[t]??!0:e[`dashboardCard_${t}`]===`on`]))}function qn(e,t){let n=t?.mealSlots??V.mealSlots;return Object.fromEntries(O.map(t=>[t,e[`mealSlot_${t}`]===void 0?n[t]??!1:e[`mealSlot_${t}`]===`on`]))}function Jn(e,t){return t.includes(e)?e:t[0]}function Yn(e){if(e==null||e===``)return null;let t=Number(e);return Number.isFinite(t)?t:null}function H(e,t){let n=Yn(e);return n===null?t:n}var Xn=class{constructor({repositoryFactory:e}){this.repository=e.getRepository(u.settings)}async getSettings(){return await this.repository.getById(`app-settings`)??V}async saveSettings(e){let t=Un(e,await this.getSettings());return await this.repository.save(t),t}async resetSettings(){let e=Un(V);return await this.repository.save(e),e}},Zn=class{constructor({repository:e,eventBus:t}){this.repository=e,this.eventBus=t,this.settings=null,this.message=``,this.expandedSections=new Set}async initialize(){this.settings=await this.repository.getSettings()}getState(){return{settings:this.settings,message:this.message,expandedSections:[...this.expandedSections]}}async handleAction(e,t={}){if(e===`save`){this.settings=await this.repository.saveSettings(t),this.message=`message.settingsSaved`,this.eventBus.publish(`settings:changed`,this.settings);return}if(e===`reset`){this.settings=await this.repository.resetSettings(),this.message=`message.settingsReset`,this.eventBus.publish(`settings:changed`,this.settings);return}e===`toggleSection`&&this.#e(t.section)}#e(e){e&&(this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e))}},Qn=class{constructor({repositoryFactory:e}){this.repository=e.getRepository(u.weights)}async list(){return _e(await this.repository.getAll(),`recordedAt`)}async getById(e){return this.repository.getById(e)}async save(e){return this.repository.save(e)}async delete(e){return this.repository.delete(e)}};function $n(e={},t){let n=T();return{id:t?.id??e.id??P(`weight`),recordedAt:e.recordedAt||t?.recordedAt||w(),weight:C(e.weight??t?.weight),unit:e.unit||t?.unit||`lb`,notes:String(e.notes??t?.notes??``).trim(),createdAt:t?.createdAt??n,updatedAt:n}}function er(e){let t={};return e.recordedAt||(t.recordedAt=`validation.dateRequired`),(e.weight===null||e.weight<=0)&&(t.weight=`validation.weightPositive`),t}var tr=class extends wt{constructor({repository:e,eventBus:t}){super({repository:e,eventBus:t,entityName:`weight-tracking`,createEntity:$n,validateEntity:er})}},nr=Object.freeze({"nutri-ia":`meal-register`,"nutri-ia-help":`nutri-ia`,"nutri-ia-success":`meal-register`}),rr=class{constructor(){this.isOpen=!1,this.activeDialog=null,this.lastImportedMeal=null}async initialize(){}getState(){return{isOpen:this.isOpen,activeDialog:this.activeDialog,lastImportedMeal:this.lastImportedMeal}}async handleAction(e,t={}){if(e===`open`){this.isOpen=!0,this.activeDialog=null;return}if(e===`close`){this.isOpen=!1,this.activeDialog=null,this.lastImportedMeal=null;return}if(e===`openDialog`){this.activeDialog=t.dialog;return}if(e===`showImportSuccess`){this.activeDialog=`nutri-ia-success`,this.lastImportedMeal=t;return}e===`closeDialog`&&(this.activeDialog=nr[this.activeDialog]??null,this.lastImportedMeal=null)}};function ir({persistence:e,eventBus:t}){let n=e.repositoryFactory,r=new Sn({repositoryFactory:n}),i=new Qn({repositoryFactory:n}),a=new Ct({repositoryFactory:n}),o=new Mn({repositoryFactory:n}),s=new Ot({repositoryFactory:n}),c=new bn({repositoryFactory:n}),l=new Xt({repositoryFactory:n}),u=new wn({repositoryFactory:n}),d=new Xn({repositoryFactory:n}),f=new bt({backupService:e.backupService});return{dashboard:new Pt({repository:new Nt({mealJournalRepository:r,weightTrackingRepository:i,bodyMeasurementsRepository:a,medicationRepository:o,dailyHabitsRepository:s})}),"meal-journal":new Cn({repository:r,eventBus:t}),"weight-tracking":new tr({repository:i,eventBus:t}),"body-measurements":new Dt({repository:a,eventBus:t}),medication:new Fn({repository:o,eventBus:t}),"daily-habits":new jt({repository:s,eventBus:t}),"food-library":new xn({repository:c,mealJournalRepository:r,eventBus:t}),favorites:new _n({repository:l,foodLibraryRepository:c,mealJournalRepository:r,eventBus:t}),"meal-plans":new jn({repository:u,favoriteMealsRepository:l,foodLibraryRepository:c,mealJournalRepository:r,eventBus:t}),settings:new Zn({repository:d,eventBus:t}),"backup-restore":new xt({repository:f,eventBus:t}),fab:new rr,developer:new qt({repositoryFactory:n,foodLibraryRepository:c,eventBus:t})}}var ar=`/Health-Weight-Pro/`;function or(e){return e===`/`?ar:`${ar}${e.slice(1)}`}function sr(e){if(!e.startsWith(ar))return`/`;let t=e.slice(19).replace(/\/+$/,``);return t?`/${t}`:`/`}function cr({routes:e,logger:t}){let n=new Map(e.map(e=>[e.path,e])),r=new Set,i=n.get(`/`)??e[0];function a(e){return n.get(e)??n.get(`/`)??i}function o(){r.forEach(e=>e(i))}return{getCurrentRoute(){return i},getRoutes(){return e},toHref(e){return or(e)},navigate(e){let n=a(e);n.path!==i.path&&(i=n,window.history.pushState({},``,or(i.path)),document.title=`${i.label} | Health Weight Pro`,t.info(`Navigation changed.`,{path:i.path}),o())},onChange(e){return r.add(e),()=>r.delete(e)},start(){i=a(sr(window.location.pathname)),document.title=`${i.label} | Health Weight Pro`,window.addEventListener(`popstate`,()=>{i=a(sr(window.location.pathname)),document.title=`${i.label} | Health Weight Pro`,o()}),o()}}}function U(e,t=`success`,n,r={}){return e?`<p class="form-message form-message--${t}">${y(lr(e,n,r))}</p>`:``}function W(e,t,n){return e[t]?`<span class="field-error">${y(lr(e[t],n))}</span>`:``}function G(e){return`<p class="empty-state">${y(e)}</p>`}function K(e){return y(e??``)}function q(e){return e==null?``:y(e)}function lr(e,t,n={}){if(!t?.t)return e;let r=Object.fromEntries(Object.entries(n).map(([e,n])=>[e,typeof n==`string`&&n.includes(`.`)?t.t(n):n]));return t.t(e,r)}function ur(e){let t=e.app.i18n;return`
    <section class="module-screen" aria-labelledby="backup-title">
      ...
      <section class="content-panel">
        ...
        ${U(e.message,`success`,t,e.messageParams)}
        ${U(e.error,`error`,t,e.errorParams)}
        <div class="form-actions">
          <button type="button" data-module="backup-restore" data-action="export">${t.t(`backup.exportJson`)}</button>
        </div>
        <textarea class="backup-textarea" readonly rows="10">${K(e.exportText)}</textarea>
      </section>
      ...
      <section class="content-panel">
        ...
        <form class="module-form module-form--single" data-module="backup-restore" data-action="import">
          <label class="module-form__wide">
            ...
            <textarea name="importText" rows="10" placeholder="${t.t(`backup.placeholder`)}">${K(e.importText)}</textarea>
          </label>
          <div class="form-actions">
  ...
  `}function dr(e){let t=e.editingRecord??{},n=e.app.i18n,r=e.app.units.measurement;return`
    <section class="module-screen" aria-labelledby="body-title">
      ...
      <section class="content-panel">
        ...
        ${U(e.message,`success`,n)}
        <form class="module-form" data-module="body-measurements" data-action="save">
          <label>
            <span>${n.t(`common.date`)}</span>
            <input name="recordedAt" type="date" value="${K(t.recordedAt??w())}" />
            ${W(e.errors,`recordedAt`,n)}
          </label>
          <label>
          ...
          <label>
            ...
            <input name="chest" type="number" min="0" step="0.1" value="${q(t.chest)}" />
          </label>
          <label>
            <span>${n.t(`body.waist`)}</span>
            <input name="waist" type="number" min="0" step="0.1" value="${q(t.waist)}" />
          </label>
          <label>
            <span>${n.t(`body.hips`)}</span>
            <input name="hips" type="number" min="0" step="0.1" value="${q(t.hips)}" />
          </label>
          <label>
            <span>${n.t(`body.arm`)}</span>
            <input name="arm" type="number" min="0" step="0.1" value="${q(t.arm)}" />
          </label>
          <label>
            <span>${n.t(`body.thigh`)}</span>
            <input name="thigh" type="number" min="0" step="0.1" value="${q(t.thigh)}" />
          </label>
          <label class="module-form__wide">
            <span>${n.t(`common.notes`)}</span>
            <textarea name="notes" rows="3">${K(t.notes)}</textarea>
            ${W(e.errors,`measurements`,n)}
          </label>
          <div class="form-actions">
  ...
  `}function fr(e,t){return e.length===0?G(t.t(`body.empty`)):`
  ...
  `}function pr(e,t){let n={chest:t.t(`body.chest`),waist:t.t(`body.waist`),hips:t.t(`body.hips`),arm:t.t(`body.arm`),thigh:t.t(`body.thigh`)};return[`chest`,`waist`,`hips`,`arm`,`thigh`].filter(t=>e[t]!==null&&e[t]!==void 0).map(r=>`${y(n[r])}: ${y(t.formatNumber(e[r]))}`).join(` &middot; `)}var mr=[{key:`calories`,labelKey:`dashboard.calories`,unit:`kcal`,icon:`flame`},{key:`protein`,labelKey:`dashboard.protein`,unit:`g`,icon:`protein`},{key:`water`,labelKey:`dashboard.water`,unit:`mL`,icon:`water`},{key:`sleep`,labelKey:`dashboard.sleep`,unit:`h`,icon:`moon`},{key:`steps`,labelKey:`dashboard.steps`,icon:`steps`},{key:`weight`,labelKey:`dashboard.weight`,icon:`scale`},{key:`medication`,labelKey:`dashboard.medication`,icon:`syringe`},{key:`recentMeals`,labelKey:`dashboard.recentMealsCard`,icon:`utensils`},{key:`recentActivity`,labelKey:`dashboard.recentActivityCard`,icon:`activity`}];function hr(e){let t=e.summary??{},n=e.app.settings??{},r=e.app.i18n,i=e.justAchievedKeys??[],a=e.allGoalsJustAchieved??!1,o=_r({summary:t,settings:n,i18n:r,units:e.app.units,justAchievedKeys:i}),s=o.filter(e=>e.key===`medication`&&n.medication?.enabled===!1?!1:n.dashboardCards?.[e.key]??!0),c=s.filter(e=>e.achievable),l=c.length>0&&c.every(e=>e.achieved);return`
  ...
  `}var gr=new Set([`calories`,`protein`,`water`,`steps`,`sleep`]);function _r({summary:e,settings:t,i18n:n,units:r,justAchievedKeys:i=[]}){let a=t.medication??{},o=e.dailyHabits??{},s=e.latestWeight?.weight??t.currentWeight??0,c=e.latestMedicationApplication?.doseMg??0,l={calories:t.calorieGoal??0,protein:t.proteinGoal??0,water:t.waterGoal??0,sleep:t.sleepGoal??0,steps:t.stepGoal??0,weight:t.targetWeight??0,medication:a.defaultDose??0,recentMeals:3,recentActivity:7},u={calories:e.todayCalories??0,protein:e.todayProtein??0,water:o.waterMl??0,sleep:(o.sleepMinutes??0)/60,steps:o.steps??0,weight:s,medication:c,recentMeals:e.todayMealCount??0,recentActivity:e.activityCount??0};return mr.map(e=>{let t=e.key,o=t===`water`,s=t===`weight`?r.weight:t===`medication`?a.doseUnit||`mg`:e.unit??``,c=Sr(u[t],l[t],t),d=gr.has(t),f=d&&l[t]>0&&u[t]>=l[t],ee=Math.max(0,l[t]-u[t]),p=o?`L`:t===`steps`?n.t(`dashboard.stepsUnit`):s,m=o?2:1,h=e=>o?e/1e3:e;return{...e,title:t===`medication`?a.name||n.t(e.labelKey):void 0,subtitle:t===`medication`&&a.applicationDay?`${n.t(`dashboard.nextApplication`)}: ${n.t(`day.${a.applicationDay}`)}`:void 0,current:u[t],currentLabel:J(u[t],s,n),goal:l[t],goalLabel:J(l[t],s,n),cardCurrentLabel:J(h(u[t]),p,n,m),cardGoalLabel:J(h(l[t]),p,n,m),remainingLabel:J(h(ee),p,n,m),achievable:d,achieved:f,justAchieved:i.includes(t),percent:c,status:Cr(c),unit:s}})}function vr(e,t,n){let r=t.displayName?n.t(`dashboard.greeting`,{name:t.displayName}):n.t(`dashboard.greetingNoName`),i=e.find(e=>e.key===`calories`),a=e.find(e=>e.key===`protein`),o=e.find(e=>e.key===`water`),s=e.find(e=>e.key===`sleep`),c=[i,a,o,s].filter(e=>e.goal>e.current).map(e=>`${J(e.goal-e.current,e.unit,n)} ${n.t(e.labelKey)}`);return`
    <section class="daily-summary">
      <div class="daily-summary__copy">
        <p class="module-screen__eyebrow">${n.t(`dashboard.smartSummary`)}</p>
        <h2>${r}</h2>
        <p class="daily-summary__date">${n.t(`common.today`)}, ${y(n.formatLongDate(w()))}</p>
        <p>${n.t(`dashboard.todayConsumed`)} <strong>${i.currentLabel}</strong> (${i.percent}%).</p>
      </div>
      <div class="daily-summary__stats">
        ${[a,o,s].map(e=>yr(e,n)).join(``)}
      </div>
  ...
  `}function br(e,t){return`
    <article class="metric-card ${[`metric-card--${e.status}`,e.justAchieved?`metric-card--celebrate`:``].filter(Boolean).join(` `)}">
      <div class="metric-card__header">
        <span class="metric-card__icon" aria-hidden="true">${wr(e.icon)}</span>
  ...
  `}var Tr=[`details`,`items`,`preview`],Er=[{value:`mostUsed`,icon:`⭐`,labelKey:`favorites.sort.mostUsed`},{value:`recentlyUsed`,icon:`🕒`,labelKey:`favorites.sort.recentlyUsed`},{value:`alphabetical`,icon:`🔤`,labelKey:`favorites.sort.alphabetical`}];function Y(e,t){return e===`custom`?t.t(`favorites.category.custom`):t.t(`mealSlot.${e}`)}function Dr(e){return[...Re(e),`custom`]}function Or(e){let t=e.app.i18n,n=e.app.settings??{},r=e.favoriteMeals??[],i=e.foods??[],a=r.length===0;return`
    <section class="module-screen" aria-labelledby="favorites-title">
      ...
      ${a?Ar(t):jr(r,i,e.sortOption,n,e.message,t)}

      ${e.activeDialog===`wizard`&&e.draft?Pr(e,n,t):``}
      ${e.activeDialog===`quick-save`&&e.draft?Fr(e,n,t):``}
      ${e.activeDialog===`delete-confirm`?Hr(r.find(t=>t.id===e.selectedFavoriteId),t):``}
    </section>
  `}function kr(e,t){let n=t.app.i18n,r=t.foods??[];if(Kr(e,t.favoriteMeals??[],r,n),t.activeDialog===`wizard`&&t.wizardStep===`items`)if(t.pickingFood){let r=t.editingItemIndex===null?null:t.draft.items[t.editingItemIndex],i=r?r.quantity:t.pickingFood.servingSize;Jr(e,t.pickingFood,i,n)}else qr(e,r,n)}function Ar(e){return`
  ...
  `}function jr(e,t,n,r,i,a){return`
    <section class="content-panel">
      ${U(i,`success`,a)}
      ...
      <div class="favorites__toolbar">
        ...
        <select class="favorites__category-filter" data-favorite-category-filter aria-label="${a.t(`favorites.category`)}">
          ...
          ${Dr(r).map(e=>`<option value="${e}">${Y(e,a)}</option>`).join(``)}
        </select>
  ...
  `}function Mr(e,t,n){return e.length===0?G(n.t(`favorites.noResults`)):e.map(e=>Nr(e,t,n)).join(``)}function Nr(e,t,n){let r=R(e,t);return`
    <article class="favorite-card" data-module="favorites" data-action="register" data-id="${e.id}" role="button" tabindex="0">
      <div class="favorite-card__header">
        <h3>${y(e.name)}</h3>
        <span class="favorite-card__category">${y(Y(e.category,n))}</span>
      </div>
  ...
  `}function Pr(e,t,n){let{draft:r,wizardMode:i,wizardStep:a}=e,o=n.t(i===`edit`?`favorites.editFavorite`:`favorites.createFavorite`),s=Tr.indexOf(a);return`
    ...
    <div class="bottom-sheet favorites-wizard" role="dialog" aria-modal="true" aria-label="${o}">
      ...
      <div class="favorites-wizard__steps" aria-hidden="true">
        ${Tr.map((e,t)=>`<span class="favorites-wizard__step${t<=s?` is-active`:``}"></span>`).join(``)}
      </div>
      ${a===`details`?Ir(r,e.errors,t,n):a===`items`?Lr(e,n):Rr(e,n)}
    </div>
  `}function Fr(e,t,n){let{draft:r,errors:i}=e,a=n.t(`favorites.saveAsFavorite`);return`
    <button type="button" class="bottom-sheet-overlay" data-module="favorites" data-action="closeDialog" aria-label="${n.t(`common.close`)}"></button>
    <div class="bottom-sheet" role="dialog" aria-modal="true" aria-label="${a}">
      <div class="bottom-sheet__header">
        <h2>${a}</h2>
        <button type="button" class="bottom-sheet__close" data-module="favorites" data-action="closeDialog" aria-label="${n.t(`common.close`)}">×</button>
      </div>
      <form class="module-form" data-module="favorites" data-action="saveQuickFavorite">
        <label class="module-form__wide">
          <span>${n.t(`favorites.mealName`)}</span>
          <input name="name" value="${K(r.name)}" placeholder="${n.t(`favorites.namePlaceholder`)}" />
          ${W(i,`name`,n)}
        </label>
        <label>
          <span>${n.t(`favorites.category`)}</span>
          <select name="category">${Ur(r.category,t,n)}</select>
        </label>
        <div class="form-actions">
          <button type="submit">${n.t(`common.save`)}</button>
          <button type="button" data-module="favorites" data-action="closeDialog">${n.t(`common.cancel`)}</button>
        </div>
      </form>
    </div>
  `}function Ir(e,t,n,r){return`
    <form class="module-form" data-module="favorites" data-action="saveDetails">
      <label class="module-form__wide">
        ...
        <input name="name" value="${K(e.name)}" placeholder="${r.t(`favorites.namePlaceholder`)}" />
        ${W(t,`name`,r)}
      </label>
      <label>
        <span>${r.t(`favorites.category`)}</span>
        <select name="category">${Ur(e.category,n,r)}</select>
      </label>
      <div class="form-actions">
  ...
  `}function Lr(e,t){let{draft:n,foods:r,pickingFood:i,editingItemIndex:a}=e;if(i){let e=a===null?null:n.items[a],r=e?e.quantity:i.servingSize;return`
      <div class="favorites-wizard__section">
        ...
        <form class="module-form module-form--single" data-module="favorites" data-action="addItem">
          ...
          <label>
            <span>${t.t(`foodLibrary.quantity`)} (${y(Wr(i.servingUnit,t))})</span>
            <input name="quantity" type="number" min="0" step="0.1" value="${q(r)}" data-favorite-quantity-input />
          </label>
  ...
  `}function Rr(e,t){let{draft:n,foods:r,totals:i}=e;return`
    <div class="favorites-wizard__section">
      <p class="favorites-preview__name">${y(n.name)}</p>
      <span class="favorite-card__category">${y(Y(n.category,t))}</span>
    </div>
    <div class="favorites-wizard__section">
      ${Br(n.items,r,t)}
    </div>
  ...
  `}function zr(e,t){return e.length===0?G(t.t(`foodLibrary.noResults`)):e.map(e=>`
        <article class="food-card food-card--compact" data-module="favorites" data-action="openFoodPicker" data-id="${e.id}" role="button" tabindex="0">
          ...
          <p class="food-card__serving">${t.formatNumber(e.servingSize)} ${y(Wr(e.servingUnit,t))}</p>
        </article>
      `).join(``)}function Br(e,t,n){return!e||e.length===0?G(n.t(`favorites.noFoodsAddedYet`)):`
    <div class="favorites-item-list">
      ${e.map((e,r)=>{let i=fn(t,e);return`
            <div class="favorites-item-row">
              <div>
                <strong>${y(i?Gr(i,n):n.t(`common.noRecord`))}</strong>
                <span>${n.formatNumber(e.quantity)} ${y(Wr(e.servingUnit,n))}</span>
              </div>
  ...
  `:``}function Ur(e,t,n){let r=Dr(t);return(r.includes(e)?r:[...r,e]).map(t=>`<option value="${t}" ${b(e,t)}>${Y(t,n)}</option>`).join(``)}function Wr(e,t){return e===`g`||e===`mL`?e:t.t(`foodLibrary.unit.${e}`)}function Gr(e,t){return e.isBuiltIn&&e.foodCode&&(e.name===F(e.foodCode,`en`)||e.name===F(e.foodCode,`pt-BR`))?F(e.foodCode,t.language)??e.name:e.name}function Kr(e,t,n,r){let i=e?.querySelector(`[data-favorite-search]`),a=e?.querySelector(`[data-favorite-category-filter]`),o=e?.querySelector(`[data-favorite-list]`);if(!i||!o)return;let s=()=>{let e=i.value.trim().toLowerCase(),s=a?.value??`all`,c=t.filter(t=>{let n=s===`all`||t.category===s,i=Y(t.category,r).toLowerCase(),a=t.name.toLowerCase(),o=!e||a.includes(e)||i.includes(e);return n&&o});o.innerHTML=Mr(c,n,r)};i.addEventListener(`input`,s),a?.addEventListener(`change`,s)}function qr(e,t,n){let r=e?.querySelector(`[data-favorite-food-search]`),i=e?.querySelector(`[data-favorite-food-results]`);!r||!i||r.addEventListener(`input`,()=>{let e=r.value.trim().toLowerCase(),a=t.filter(t=>{let r=n.t(`foodLibrary.category.${t.category}`).toLowerCase(),i=Gr(t,n).toLowerCase();return!e||i.includes(e)||r.includes(e)});i.innerHTML=zr(a,n)})}function Jr(e,t,n,r){let i=e?.querySelector(`[data-favorite-quantity-input]`),a=e?.querySelector(`[data-favorite-quantity-preview]`);if(!i||!a)return;let o=()=>{let e=Number(i.value)||0,n=t.servingSize>0?e/t.servingSize:0;a.innerHTML=Vr({calories:t.calories*n,protein:t.protein*n,carbs:t.carbs*n,fat:t.fat*n,fiber:t.fiber*n},r)};i.addEventListener(`input`,o),o()}function Yr(e){let t=e.app.i18n,n=e.foods??[],r=n.length===0;return`
    <section class="module-screen" aria-labelledby="food-library-title">
      ...
      ${r?Zr(t):Qr(n,e.message,t)}

      ${e.activeDialog===`form`?ti(e,t):``}
      ${e.activeDialog===`quantity`&&e.selectedFood?ni(e.selectedFood,t):``}
      ${e.activeDialog===`delete-confirm`&&e.selectedFood?ri(e.selectedFood,t):``}
    </section>
  `}function Xr(e,t){let n=t.app.i18n;ci(e,t.foods??[],n),t.activeDialog===`quantity`&&t.selectedFood&&li(e,t.selectedFood,n)}function Zr(e){return`
    ...
    <section class="content-panel">
      ...
      <div class="food-library__toolbar">
        ...
        <select class="food-library__category-filter" data-food-category-filter aria-label="${n.t(`foodLibrary.category`)}">
          ...
          ${It.map(e=>`<option value="${e}">${n.t(`foodLibrary.category.${e}`)}</option>`).join(``)}
        </select>
  ...
  `}function $r(e,t){return e.length===0?G(t.t(`foodLibrary.noResults`)):e.map(e=>ei(e,t)).join(``)}function ei(e,t){return`
    <article class="food-card" data-module="food-library" data-action="openQuantity" data-id="${e.id}" role="button" tabindex="0">
      <div class="food-card__header">
        <h3>${y(X(e,t))}</h3>
        <span class="food-card__category">${y(t.t(`foodLibrary.category.${e.category}`))}</span>
      </div>
      <p class="food-card__serving">${t.formatNumber(e.servingSize)} ${y(oi(e.servingUnit,t))}</p>
  ...
  `}function ti(e,t){let n=e.editingFood??{},r=!!e.editingFood;return`
    ...
    <div class="bottom-sheet" role="dialog" aria-modal="true" aria-label="${t.t(r?`foodLibrary.editFood`:`foodLibrary.addFood`)}">
      ...
      <form class="module-form" data-module="food-library" data-action="save">
        <label class="module-form__wide">
          ...
          <input name="name" value="${K(r?X(n,t):n.name)}" />
          ${W(e.errors,`name`,t)}
        </label>
        <label>
          <span>${t.t(`foodLibrary.category`)}</span>
          <select name="category">${ii(n.category??`others`,t)}</select>
        </label>
        <label>
          <span>${t.t(`foodLibrary.servingSize`)}</span>
          <input name="servingSize" type="number" min="0" step="0.1" value="${q(n.servingSize??100)}" />
          ${W(e.errors,`servingSize`,t)}
        </label>
        <label>
          <span>${t.t(`foodLibrary.servingUnit`)}</span>
          <select name="servingUnit">${ai(n.servingUnit??`g`,t)}</select>
        </label>
        <label>
          <span>${t.t(`settings.calories`)}</span>
          <input name="calories" type="number" min="0" step="0.1" value="${q(n.calories??0)}" />
        </label>
        <label>
          <span>${t.t(`settings.protein`)}</span>
          <input name="protein" type="number" min="0" step="0.1" value="${q(n.protein??0)}" />
        </label>
        <label>
          <span>${t.t(`settings.carbohydrates`)}</span>
          <input name="carbs" type="number" min="0" step="0.1" value="${q(n.carbs??0)}" />
        </label>
        <label>
          <span>${t.t(`settings.fat`)}</span>
          <input name="fat" type="number" min="0" step="0.1" value="${q(n.fat??0)}" />
        </label>
        <label>
          <span>${t.t(`settings.fiber`)}</span>
          <input name="fiber" type="number" min="0" step="0.1" value="${q(n.fiber??0)}" />
        </label>
        <div class="form-actions">
  ...
  `}function ni(e,t){let n=oi(e.servingUnit,t);return`
    <button type="button" class="bottom-sheet-overlay" data-module="food-library" data-action="closeDialog" aria-label="${t.t(`common.close`)}"></button>
  ...
  `}function ri(e,t){return`
    ...
    <div class="bottom-sheet" role="alertdialog" aria-modal="true" aria-label="${t.t(`foodLibrary.deleteConfirmTitle`)}">
      ...
      <p>${y(t.t(`foodLibrary.deleteConfirmMessage`,{name:X(e,t)}))}</p>
      <div class="form-actions">
  ...
  `}function ii(e,t){return It.map(n=>`<option value="${n}" ${b(e,n)}>${t.t(`foodLibrary.category.${n}`)}</option>`).join(``)}function ai(e,t){return Lt.map(n=>`<option value="${n}" ${b(e,n)}>${oi(n,t)}</option>`).join(``)}function oi(e,t){return e===`g`||e===`mL`?e:t.t(`foodLibrary.unit.${e}`)}function X(e,t){return e.isBuiltIn&&e.foodCode&&(e.name===F(e.foodCode,`en`)||e.name===F(e.foodCode,`pt-BR`))?F(e.foodCode,t.language)??e.name:e.name}function si(e,t){return`
    <div class="food-preview-card">
      <dl class="food-preview-grid">
        <div><dt>${t.t(`settings.calories`)}</dt><dd>${t.formatNumber(e.calories)} kcal</dd></div>
        <div><dt>${t.t(`settings.protein`)}</dt><dd>${t.formatNumber(e.protein)} g</dd></div>
  ...
  `}function ci(e,t,n){let r=e?.querySelector(`[data-food-search]`),i=e?.querySelector(`[data-food-category-filter]`),a=e?.querySelector(`[data-food-list]`);if(!r||!a)return;let o=()=>{let e=r.value.trim().toLowerCase(),o=i?.value??`all`,s=t.filter(t=>{let r=o===`all`||t.category===o,i=n.t(`foodLibrary.category.${t.category}`).toLowerCase(),a=X(t,n).toLowerCase(),s=!e||a.includes(e)||i.includes(e);return r&&s});a.innerHTML=$r(s,n)};r.addEventListener(`input`,o),i?.addEventListener(`change`,o)}function li(e,t,n){let r=e?.querySelector(`[data-quantity-input]`),i=e?.querySelector(`[data-quantity-preview]`);if(!r||!i)return;let a=()=>{let e=Number(r.value)||0,a=t.servingSize>0?e/t.servingSize:0;i.innerHTML=si({calories:t.calories*a,protein:t.protein*a,carbs:t.carbs*a,fat:t.fat*a,fiber:t.fiber*a},n)};r.addEventListener(`input`,a),a()}function ui(e){let t=e.app.i18n,n=e.editingRecord;return`
    <section class="module-screen" aria-labelledby="meal-title">
      <div class="module-screen__header">
        <p class="module-screen__eyebrow">${t.t(`route.mealJournal`)}</p>
        <h1 id="meal-title">${t.t(`route.mealJournal`)}</h1>
        <p>${t.t(`meal.description`)}</p>
      </div>

      ${n?di(n,e,t):``}

      <section class="content-panel">
        <h2>${t.t(`meal.listTitle`)}</h2>
        ${n?``:U(e.message,`success`,t)}
        ${fi(e.records,t)}
      </section>
    </section>
  `}function di(e,t,n){let r=Re(t.app.settings??{}),i=e.mealType&&!r.includes(e.mealType)?[...r,e.mealType]:r;return`
    <section class="content-panel">
      <h2>${n.t(`meal.edit`)}</h2>
      ${U(t.message,`success`,n)}
      <form class="module-form" data-module="meal-journal" data-action="save">
        <label>
          <span>${n.t(`common.date`)}</span>
          <input name="mealDate" type="date" value="${K(e.mealDate)}" />
          ${W(t.errors,`mealDate`,n)}
        </label>
        <label>
          <span>${n.t(`meal.type`)}</span>
          <select name="mealType">
            ${i.map(t=>`<option value="${t}" ${b(e.mealType,t)}>${n.t(k(t))}</option>`).join(``)}
          </select>
        </label>
        <label class="module-form__wide">
          <span>${n.t(`meal.name`)}</span>
          <input name="title" value="${K(e.title)}" placeholder="${n.t(`meal.placeholder`)}" />
          ${W(t.errors,`title`,n)}
        </label>
        <label class="module-form__wide">
          <span>${n.t(`common.notes`)}</span>
          <textarea name="notes" rows="3" placeholder="${n.t(`meal.optionalNotes`)}">${K(e.notes)}</textarea>
        </label>
        <div class="form-actions">
          <button type="submit">${n.t(`common.saveChanges`)}</button>
          <button type="button" data-action="cancel">${n.t(`common.cancel`)}</button>
        </div>
      </form>
    </section>
  `}function fi(e,t){return e.length===0?G(t.t(`meal.empty`)):`
    <div class="record-list">
      ${e.map(e=>`
            <article class="record-card">
              <div>
                <span class="record-card__meta">${y(t.formatDate(e.mealDate))} &middot; ${y(t.t(k(e.mealType)))}</span>
                <h3>${y(e.title)}</h3>
  ...
  `}var pi=[`details`,`meals`,`preview`];function mi(e){let t=e.app.i18n,n=e.mealPlans??[],r=e.favoriteMeals??[],i=e.foods??[],a=n.length===0;return`
    <section class="module-screen" aria-labelledby="meal-plans-title">
      ...
      ${a?gi(t):_i(n,r,i,e.message,t)}

      ${e.activeDialog===`wizard`&&e.draft?bi(e,e.app.settings??{},t):``}
      ${e.activeDialog===`delete-confirm`?Di(n.find(t=>t.id===e.selectedPlanId),t):``}
    </section>
  `}function hi(e,t){let n=t.app.i18n,r=t.favoriteMeals??[],i=t.foods??[];Oi(e,t.mealPlans??[],r,i,n),t.activeDialog===`wizard`&&t.wizardStep===`meals`&&!t.pickingFavoriteMeal&&ki(e,r,i,n)}function gi(e){return`
  ...
  `}function vi(e,t,n,r){return e.length===0?G(r.t(`mealPlans.noResults`)):e.map(e=>yi(e,t,n,r)).join(``)}function yi(e,t,n,r){let i=An(e,t,n);return`
  ...
  `}function bi(e,t,n){let{draft:r,wizardMode:i,wizardStep:a}=e,o=n.t(i===`edit`?`mealPlans.editPlan`:`mealPlans.createPlan`),s=pi.indexOf(a);return`
    ...
    <div class="bottom-sheet favorites-wizard" role="dialog" aria-modal="true" aria-label="${o}">
      ...
      <div class="favorites-wizard__steps" aria-hidden="true">
        ${pi.map((e,t)=>`<span class="favorites-wizard__step${t<=s?` is-active`:``}"></span>`).join(``)}
      </div>
      ${a===`details`?xi(r,e.errors,n):a===`meals`?Si(e,t,n):Ci(e,n)}
    </div>
  `}function xi(e,t,n){return`
    <form class="module-form" data-module="meal-plans" data-action="saveDetails">
      <label class="module-form__wide">
        <span>${n.t(`mealPlans.planName`)}</span>
        <input name="name" value="${K(e.name)}" placeholder="${n.t(`mealPlans.namePlaceholder`)}" />
        ${W(t,`name`,n)}
      </label>
      <label class="module-form__wide">
        <span>${n.t(`mealPlans.planDescription`)}</span>
        <textarea name="description" rows="3" placeholder="${n.t(`mealPlans.descriptionPlaceholder`)}">${K(e.description)}</textarea>
      </label>
      <div class="form-actions">
  ...
  `}function Si(e,t,n){let{draft:r,favoriteMeals:i,foods:a,pickingFavoriteMeal:o,editingMealIndex:s}=e;if(o){let e=s===null?null:r.meals[s],i=Re(t),c=e?.mealSlot&&!i.includes(e.mealSlot)?[...i,e.mealSlot]:i,l=R(o,a);return`
      <div class="favorites-wizard__section">
        <h3>${y(o.name)}</h3>
        ...
        <form class="module-form module-form--single" data-module="meal-plans" data-action="addMeal">
          ...
          <label>
            ...
            <select name="mealSlot">
              ${c.map(t=>`<option value="${t}" ${b(e?.mealSlot,t)}>${n.t(k(t))}</option>`).join(``)}
            </select>
          </label>
          <div class="form-actions">
  ...
  `}function Ci(e,t){let{draft:n,favoriteMeals:r,totals:i}=e;return`
    <div class="favorites-wizard__section">
      <p class="favorites-preview__name">${y(n.name)}</p>
  ...
  `}function wi(e,t,n){return e.length===0?G(n.t(`favorites.noResults`)):e.map(e=>{let r=R(e,t);return`
      ...
      `}).join(``)}function Ti(e,t,n){return!e||e.length===0?G(n.t(`mealPlans.noMealsAddedYet`)):`
    <div class="favorites-item-list">
      ${e.map((e,r)=>{let i=kn(t,e);return`
            <div class="favorites-item-row">
              <div>
                <strong>${y(i?i.name:n.t(`common.noRecord`))}</strong>
                <span>${y(n.t(k(e.mealSlot)))}</span>
              </div>
              <div class="favorites-item-row__actions">
  ...
  `:``}function Oi(e,t,n,r,i){let a=e?.querySelector(`[data-mealplan-search]`),o=e?.querySelector(`[data-mealplan-list]`);!a||!o||a.addEventListener(`input`,()=>{let e=a.value.trim().toLowerCase(),s=t.filter(t=>!e||t.name.toLowerCase().includes(e));o.innerHTML=vi(s,n,r,i)})}function ki(e,t,n,r){let i=e?.querySelector(`[data-mealplan-favorite-search]`),a=e?.querySelector(`[data-mealplan-favorite-results]`);!i||!a||i.addEventListener(`input`,()=>{let e=i.value.trim().toLowerCase(),o=t.filter(t=>!e||t.name.toLowerCase().includes(e));a.innerHTML=wi(o,n,r)})}function Ai(e){let t=e.editingRecord??{},n=e.app.i18n,r=e.app.settings?.medication??{},i=r.doseUnit||`mg`,a=r.name||n.t(`route.medication`);return`
    <section class="module-screen" aria-labelledby="medication-title">
      ...
      <section class="content-panel">
        ...
        <form class="module-form" data-module="medication" data-action="save">
          <label>
            <span>${n.t(`common.date`)}</span>
            <input name="administeredAt" type="date" value="${K(t.administeredAt??w())}" />
            ${W(e.errors,`administeredAt`,n)}
          </label>
          <label>
            <span>${n.t(`medication.doseAmount`)} (${y(i)})</span>
            <input name="doseMg" type="number" min="0" step="0.1" value="${q(t.doseMg)}" />
            ${W(e.errors,`doseMg`,n)}
          </label>
          <label>
  ...
  `}function ji(e,t,n){if(e.length===0)return G(n.t(`medication.empty`));let r=t.doseUnit||`mg`,i=t.name?`${y(t.name)} &middot; `:``;return`
    <div class="record-list">
      ${e.map(e=>`
            <article class="record-card">
              <div>
                <span class="record-card__meta">${y(n.formatDate(e.administeredAt))} &middot; ${y(Mi(e.site,n))}</span>
  ...
  `}function Mi(e,t){return t.t({abdomen:`medication.abdomen`,thigh:`medication.thigh`,"upper-arm":`medication.upperArm`,"not-specified":`medication.notSpecified`}[e]??`medication.notSpecified`)}var Ni=[{value:``,labelKey:`settings.sexNotSet`},{value:`female`,labelKey:`settings.sexFemale`},{value:`male`,labelKey:`settings.sexMale`},{value:`other`,labelKey:`settings.sexOther`}],Pi=[{value:`lose-weight`,labelKey:`settings.goalLoseWeight`},{value:`maintain-weight`,labelKey:`settings.goalMaintainWeight`},{value:`gain-muscle`,labelKey:`settings.goalGainMuscle`}],Fi=[{value:`sedentary`,labelKey:`settings.activitySedentary`},{value:`light`,labelKey:`settings.activityLight`},{value:`moderate`,labelKey:`settings.activityModerate`},{value:`intense`,labelKey:`settings.activityIntense`}],Ii=[`monday`,`tuesday`,`wednesday`,`thursday`,`friday`,`saturday`,`sunday`].map(e=>({value:e,labelKey:`day.${e}`})),Li=In.map(e=>({value:e,labelKey:`settings.administration.${e}`})),Ri=Ln.map(e=>({value:e,labelKey:`settings.frequency.${e}`})),zi=Rn.map(e=>({value:e,labelKey:`settings.doseUnit.${e}`})),Bi=[{key:`calories`,labelKey:`dashboard.calories`},{key:`protein`,labelKey:`dashboard.protein`},{key:`water`,labelKey:`dashboard.water`},{key:`sleep`,labelKey:`dashboard.sleep`},{key:`steps`,labelKey:`dashboard.steps`},{key:`weight`,labelKey:`dashboard.weight`},{key:`medication`,labelKey:`dashboard.medication`},{key:`recentMeals`,labelKey:`dashboard.recentMealsCard`},{key:`recentActivity`,labelKey:`dashboard.recentActivityCard`}];function Vi(e){let t=e.settings??{},n=e.backupStatus??{},r=e.app.i18n,i=e.app.units,a=e.expandedSections??[];return`
    <section class="module-screen" aria-labelledby="settings-title">
      ...
      <form class="settings-form" data-module="settings" data-action="save">
        ${U(e.message,`success`,r)}
        <div class="accordion">
          ${Z({key:`sistema`,title:r.t(`settings.preferences`),expandedSections:a,content:Hi(t,i,r)})}
          ${Z({key:`perfil`,title:r.t(`settings.profile`),expandedSections:a,content:Ui(t,i,r)})}
          ${Z({key:`objetivos`,title:r.t(`settings.dailyGoals`),expandedSections:a,content:Wi(t,i,r)})}
          ${Z({key:`medicacao`,title:r.t(`settings.medication`),expandedSections:a,content:Yi(t.medication??{},r)})}
          ${Z({key:`dashboard`,title:r.t(`settings.dashboardPreferences`),expandedSections:a,content:Gi(t,r)})}
        </div>
        <div class="form-actions">
      ...
      <div class="accordion">
        ${Z({key:`backup`,title:r.t(`route.backupRestore`),expandedSections:a,content:Ki(n,r)})}
      </div>
      ...
      ${e.developer?.isEnabled?`<div class="accordion">${Z({key:`desenvolvedor`,title:r.t(`developer.title`),expandedSections:a,content:qi(e.developer,r)})}</div>`:``}
      ${e.developer?.confirmingAction?Ji(e.developer.confirmingAction,r):``}
    </section>
  `}function Z({key:e,title:t,expandedSections:n,content:r}){let i=n.includes(e),a=`settings-accordion-header-${e}`,o=`settings-accordion-panel-${e}`;return`
    <div class="accordion-item${i?` is-open`:``}">
      <button
        type="button"
      ...
      <div class="accordion-item__panel">
        <div class="accordion-item__panel-inner">
          <div class="accordion-item__body" id="${o}" role="region" aria-labelledby="${a}">
            ${r}
          </div>
        </div>
      </div>
  ...
  `}function Hi(e,t,n){return`
    <div class="module-form">
      <label>
        <span>${n.t(`settings.language`)}</span>
        <select name="language">
          ${Q(be,e.language??`pt-BR`,n)}
        </select>
      </label>
      <label>
        <span>${n.t(`settings.theme`)}</span>
        <select name="theme">
          ${Q(xe,e.theme??`system`,n)}
        </select>
      </label>
      ${Zi(t,n)}
    </div>
  `}function Ui(e,t,n){return`
    <div class="form-subsection">
      <h3>${n.t(`settings.personalInfo`)}</h3>
      <div class="module-form">
        <label>
          <span>${n.t(`settings.name`)}</span>
          <input name="displayName" value="${K(e.displayName)}" />
        </label>
        <label>
          <span>${n.t(`settings.sex`)}</span>
          <select name="sex">
            ${Q(Ni,e.sex??``,n)}
          </select>
        </label>
        <label>
          <span>${n.t(`settings.birthDate`)}</span>
          <input name="birthDate" type="date" value="${K(e.birthDate)}" />
        </label>
        <label>
          <span>${n.t(`settings.height`)} (${t.measurement})</span>
          <input name="height" type="number" min="0" step="0.1" value="${q(e.height)}" />
        </label>
      </div>
    </div>

    <div class="form-subsection">
      <h3>${n.t(`settings.goal`)}</h3>
      <div class="module-form">
        <label>
          <span>${n.t(`settings.goal`)}</span>
          <select name="healthGoal">
            ${Q(Pi,e.healthGoal??`lose-weight`,n)}
          </select>
        </label>
        <label>
          <span>${n.t(`settings.activityLevel`)}</span>
          <select name="activityLevel">
            ${Q(Fi,e.activityLevel??`moderate`,n)}
          </select>
        </label>
      </div>
    </div>
  `}function Wi(e,t,n){return`
    <div class="form-subsection">
      <h3>${n.t(`settings.weightGoals`)}</h3>
      <div class="module-form">
        ${$(`currentWeight`,`settings.currentWeight`,e.currentWeight,t.weight,n)}
        ${$(`targetWeight`,`settings.targetWeight`,e.targetWeight,t.weight,n)}
      </div>
    </div>

    <div class="form-subsection">
      <h3>${n.t(`settings.nutritionGoals`)}</h3>
      <div class="module-form">
        ${$(`calorieGoal`,`settings.calories`,e.calorieGoal,`kcal`,n)}
        ${$(`proteinGoal`,`settings.protein`,e.proteinGoal,`g`,n)}
        ${$(`carbsGoal`,`settings.carbohydrates`,e.carbsGoal,`g`,n)}
        ${$(`fatGoal`,`settings.fat`,e.fatGoal,`g`,n)}
        ${$(`fiberGoal`,`settings.fiber`,e.fiberGoal,`g`,n)}
      </div>
    </div>

    <div class="form-subsection">
      <h3>${n.t(`settings.hydration`)}</h3>
      <div class="module-form">
        ${$(`waterGoal`,`settings.dailyWaterGoal`,e.waterGoal,`mL`,n)}
      </div>
    </div>

    <div class="form-subsection">
      <h3>${n.t(`settings.sleep`)}</h3>
      <div class="module-form">
        ${$(`sleepGoal`,`settings.dailySleepGoal`,e.sleepGoal,`h`,n)}
      </div>
    </div>

    <div class="form-subsection">
      <h3>${n.t(`settings.steps`)}</h3>
      <div class="module-form">
        ${$(`stepGoal`,`settings.dailyStepGoal`,e.stepGoal,``,n)}
      </div>
    </div>
  `}function Gi(e,t){return`
    <div class="form-subsection">
      <h3>${t.t(`settings.visibleCards`)}</h3>
      <div class="checkbox-grid">
        ${Bi.map(n=>Qi(n,e.dashboardCards,t)).join(``)}
      </div>
    </div>

    <div class="form-subsection">
      <h3>${t.t(`settings.visibleMealSlots`)}</h3>
      <p>${t.t(`settings.visibleMealSlotsHint`)}</p>
      <div class="checkbox-grid">
        ${O.map(n=>$i(n,e.mealSlots,t)).join(``)}
      </div>
    </div>
  `}function Ki(e,t){return`
    <div class="form-subsection">
      <h3>${t.t(`settings.backupExport`)}</h3>
      ${U(e.message,`success`,t,e.messageParams)}
      ${U(e.error,`error`,t,e.errorParams)}
      <div class="form-actions">
        <button type="button" data-module="backup-restore" data-action="export">${t.t(`backup.exportJson`)}</button>
      </div>
      <textarea class="backup-textarea" readonly rows="8">${K(e.exportText)}</textarea>
    </div>

    <div class="form-subsection">
      <h3>${t.t(`settings.backupImport`)}</h3>
      <form class="module-form module-form--single" data-module="backup-restore" data-action="import">
        <label class="module-form__wide">
          <span>${t.t(`backup.json`)}</span>
          <textarea name="importText" rows="8" placeholder="${t.t(`backup.placeholder`)}">${K(e.importText)}</textarea>
        </label>
        <div class="form-actions">
          <button type="submit">${t.t(`backup.importJson`)}</button>
        </div>
  ...
  `}function qi(e,t){let n=e.versions??{},r=typeof navigator<`u`&&!!navigator.serviceWorker?.controller;return`
    ${U(e.message,`success`,t)}
  ...
  `}function Ji(e,t){let n=e===`resetFirstLaunch`?`developer.resetFirstLaunchConfirmTitle`:`developer.clearDatabaseConfirmTitle`,r=e===`resetFirstLaunch`?`developer.resetFirstLaunchConfirmMessage`:`developer.clearDatabaseConfirmMessage`;return`
  ...
  `}function Yi(e,t){let n=e.enabled??!0;return`
    <div class="module-form">
    ...
    <div class="module-form">
      ...
      <label>
        ...
        <select name="doseUnit">
          ${Q(zi,e.doseUnit??`mg`,t)}
        </select>
      </label>
      <label>
        <span>${t.t(`settings.applicationDay`)}</span>
        <select name="applicationDay">
          ${Q(Ii,e.applicationDay??`monday`,t)}
        </select>
      </label>
      <label class="module-form__wide">
        <span>${t.t(`settings.medicationNotes`)}</span>
        <textarea name="medicationNotes" rows="3">${K(e.notes)}</textarea>
      </label>
    </div>
  ...
  `}function $(e,t,n,r,i){return`
    <label>
      ...
      <input name="${e}" type="number" min="0" step="0.1" value="${q(n)}" />
    </label>
  `}function Qi(e,t={},n){let r=t?.[e.key]??!0,i=`dashboardCard_${e.key}`;return`
    <label class="checkbox-control">
      <input name="${i}" type="hidden" value="off" />
      <input name="${i}" type="checkbox" ${r?`checked`:``} />
      <span>${n.t(e.labelKey)}</span>
    </label>
  `}function $i(e,t={},n){let r=t?.[e]??!1,i=`mealSlot_${e}`;return`
    <label class="checkbox-control">
      <input name="${i}" type="hidden" value="off" />
      <input name="${i}" type="checkbox" ${r?`checked`:``} />
      <span>${n.t(`mealSlot.${e}`)}</span>
    </label>
  `}function ea(e){let t=e.editingRecord??{},n=e.app.i18n,r=e.app.units.weight;return`
      ...
      <section class="content-panel">
        ...
        <form class="module-form" data-module="weight-tracking" data-action="save">
          ...
          <label>
            ...
            <input name="weight" type="number" min="0" step="0.1" value="${q(t.weight)}" />
            ${W(e.errors,`weight`,n)}
          </label>
          <label>
            <span>${n.t(`common.unit`)}</span>
  ...
  `}function ta(e,t){return e.length===0?G(t.t(`weight.empty`)):`
    <div class="record-list">
      ${e.map(e=>`
            <article class="record-card">
              <div>
  ...
  `}var na=[{id:`dashboard`,label:`Dashboard`,labelKey:`route.dashboard`,path:`/`,section:`Core`,sectionKey:`section.core`,moduleKey:`dashboard`,render:hr},{id:`meal-journal`,label:`Meal Journal`,labelKey:`route.mealJournal`,path:`/meal-journal`,section:`Tracking`,sectionKey:`section.tracking`,moduleKey:`meal-journal`,render:ui},{id:`weight-tracking`,label:`Weight Tracking`,labelKey:`route.weightTracking`,path:`/weight-tracking`,section:`Tracking`,sectionKey:`section.tracking`,moduleKey:`weight-tracking`,render:ea},{id:`body-measurements`,label:`Body Measurements`,labelKey:`route.bodyMeasurements`,path:`/body-measurements`,section:`Tracking`,sectionKey:`section.tracking`,moduleKey:`body-measurements`,render:dr},{id:`medication`,label:`Medication`,labelKey:`route.medication`,path:`/medication`,section:`Medication`,sectionKey:`section.medication`,moduleKey:`medication`,render:Ai},{id:`favorites`,label:`Favorites`,labelKey:`route.favorites`,path:`/favorites`,section:`Tracking`,sectionKey:`section.tracking`,moduleKey:`favorites`,hidden:!0,render:Or,afterRender:kr},{id:`meal-plans`,label:`Meal Plans`,labelKey:`route.mealPlans`,path:`/meal-plans`,section:`Tracking`,sectionKey:`section.tracking`,moduleKey:`meal-plans`,hidden:!0,render:mi,afterRender:hi},{id:`food-library`,label:`Food Library`,labelKey:`route.foodLibrary`,path:`/food-library`,section:`Tracking`,sectionKey:`section.tracking`,moduleKey:`food-library`,hidden:!0,render:Yr,afterRender:Xr},{id:`settings`,label:`Settings`,labelKey:`route.settings`,path:`/settings`,section:`Support`,sectionKey:`section.support`,moduleKey:`settings`,render:Vi},{id:`backup-restore`,label:`Backup & Restore`,labelKey:`route.backupRestore`,path:`/backup-restore`,section:`Support`,sectionKey:`section.support`,moduleKey:`backup-restore`,hidden:!0,render:ur}];function ra({root:t}){let n=new r({namespace:`HWP`}),i=new e,a=ue({logger:n}),o=ir({persistence:a,eventBus:i}),s=cr({routes:na,logger:n}),c=new Ne({eventBus:i,logger:n,modules:o,persistence:a,router:s,storage:a.storage});return ge({eventBus:i,getI18nContext:()=>c.getI18nContext()}),{logger:n,async start(){if(!t)throw Error(`Application root element was not found.`);await c.initialize(),We({root:t,viewModel:c}),s.start(),n.info(`Application shell started.`)}}}function ia(e){if(!(`serviceWorker`in navigator))return;let t=`/Health-Weight-Pro/`;window.addEventListener(`load`,()=>{navigator.serviceWorker.register(`${t}sw.js`,{scope:t}).catch(t=>{e?.warn(`Service worker registration failed.`,{error:t.message})})})}var aa=ra({root:document.querySelector(`#app`)});aa.start(),ia(aa.logger);
//# sourceMappingURL=index-JGlLxoRJ.js.map